  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-primary/10 via-white to-accent/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-16 sm:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 dark:bg-primary/30 text-primary dark:text-accent mb-6">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid sm:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 text-center border border-primary/20">
                  ...
                  <div className="text-3xl font-heading font-bold text-primary mb-2">50M+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">{content.statsTitle}</div>
                </div>
                <div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 text-center border border-accent/20">
                  <div className="text-4xl mb-3">💼</div>
                  <div className="text-3xl font-heading font-bold text-accent mb-2">19M+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">{content.statsJobs}</div>
                </div>
                <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 text-center border border-secondary/20">
                  <div className="text-4xl mb-3">🏆</div>
                  <div className="text-3xl font-heading font-bold text-secondary mb-2">1M+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">{content.statsContests}</div>
                </div>
                <div className="bg-gradient-to-br from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 rounded-xl p-6 text-center border border-primary/20">
                  <div className="text-4xl mb-3">💰</div>
                  <div className="text-3xl font-heading font-bold text-primary mb-2">{currencySymbol}6B+</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">{content.statsPayout}</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="bg-gradient-to-r from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 rounded-xl p-6 border-l-4 border-primary mb-8">
                    <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                      <span>✨</span>
                      {content.overview.uniqueTitle}
                    </h3>
                    <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <div><strong className="text-gray-900 dark:text-white">Contest Model:</strong> {content.overview.unique1.split(': ')[1]}</div>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <div><strong className="text-gray-900 dark:text-white">Milestone Payments:</strong> {content.overview.unique2.split(': ')[1]}</div>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <div><strong className="text-gray-900 dark:text-white">Global Reach:</strong> {content.overview.unique3.split(': ')[1]}</div>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <div><strong className="text-gray-900 dark:text-white">Skills Tests:</strong> {content.overview.unique4.split(': ')[1]}</div>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                        ...
                        {content.overview.categoriesTitle}
                      </h4>
                      <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        <li>• {content.overview.cat1}</li>
                        <li>• {content.overview.cat2}</li>
                        <li>• {content.overview.cat3}</li>
                        <li>• {content.overview.cat4}</li>
                        <li>• {content.overview.cat5}</li>
                        <li>• {content.overview.cat6}</li>
                      </ul>
                    </div>
                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                        ...
                        {content.overview.bestForTitle}
                      </h4>
                      <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        <li>• {content.overview.best1}</li>
                        <li>• {content.overview.best2}</li>
                        <li>• {content.overview.best3}</li>
                        <li>• {content.overview.best4}</li>
                        <li>• {content.overview.best5}</li>
                        <li>• {content.overview.best6}</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6 border-l-4 border-secondary">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>🏆</span>
                        {content.features.contests.title}
                      </h3>
                      <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                        {content.features.contests.intro}
                      </p>
                      <div className="grid sm:grid-cols-2 gap-4 mb-4">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-2 text-sm">{content.features.contests.typesTitle}</h4>
                          <ul className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
                            <li>• {content.features.contests.type1}</li>
                            <li>• {content.features.contests.type2}</li>
                            <li>• {content.features.contests.type3}</li>
                            <li>• {content.features.contests.type4}</li>
                            <li>• {content.features.contests.type5}</li>
                          </ul>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-2 text-sm">{content.features.contests.benefitsTitle}</h4>
                          <ul className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
                            <li>• {content.features.contests.benefit1}</li>
                            <li>• {content.features.contests.benefit2}</li>
                            <li>• {content.features.contests.benefit3}</li>
                            <li>• {content.features.contests.benefit4}</li>
                            <li>• {content.features.contests.benefit5}</li>
                          </ul>
                        </div>
                      </div>
                      <div className="bg-accent/10 dark:bg-accent/20 rounded-lg p-4">
                        <p className="text-sm font-heading font-bold text-gray-900 dark:text-white mb-2">{content.features.contests.tip}</p>
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                          {content.features.contests.tipText}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 border-l-4 border-accent">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>💰</span>
                        {content.features.milestones.title}
                      </h3>
                      <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                        {content.features.milestones.intro}
                      </p>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-6">
                        <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.features.milestones.howTitle}</h4>
                        <ol className="space-y-3 text-gray-700 dark:text-gray-300">
                          <li className="flex items-start gap-3">
                            <span className="font-bold text-accent">1.</span>
                            <div>{content.features.milestones.step1}</div>
                          </li>
                          <li className="flex items-start gap-3">
                            <span className="font-bold text-accent">2.</span>
                            <div>{content.features.milestones.step2}</div>
                          </li>
                          <li className="flex items-start gap-3">
                            <span className="font-bold text-accent">3.</span>
                            <div>{content.features.milestones.step3}</div>
                          </li>
                          <li className="flex items-start gap-3">
                            <span className="font-bold text-accent">4.</span>
                            <div>{content.features.milestones.step4}</div>
                          </li>
                          <li className="flex items-start gap-3">
                            <span className="font-bold text-accent">5.</span>
                            <div>{content.features.milestones.step5}</div>
                          </li>
                        </ol>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6 border-l-4 border-primary">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>🎓</span>
                        {content.features.exams.title}
                      </h3>
                      <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                        {content.features.exams.intro}
                      </p>
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-2 text-sm">{content.features.exams.selectionTitle}</h4>
                          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li className="flex items-start gap-2">
                              <span className="text-accent">→</span>
                              <span>{content.features.exams.selection1}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-accent">→</span>
                              <span>{content.features.exams.selection2}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-accent">→</span>
                              <span>{content.features.exams.selection3}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-accent">→</span>
                              <span>{content.features.exams.selection4}</span>
                            </li>
                          </ul>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-2 text-sm">{content.features.exams.impactTitle}</h4>
                          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li className="flex items-start gap-2">
                              <span className="text-primary">✓</span>
                              <span>{content.features.exams.impact1}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-primary">✓</span>
                              <span>{content.features.exams.impact2}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-primary">✓</span>
                              <span>{content.features.exams.impact3}</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="text-primary">✓</span>
                              <span>{content.features.exams.impact4}</span>
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              {/* CTA Mid-Article */}
              <div className="mb-16">
                <div className="bg-gradient-to-r from-primary to-accent rounded-2xl p-8 text-center shadow-2xl">
                  <h3 className="text-2xl sm:text-3xl font-heading font-bold text-white mb-4">
                    {content.midCta.title}
                  </h3>
                  <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                    {content.midCta.subtitle}
                  </p>
                  <Link
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border-2 border-gray-300 dark:border-gray-600">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">{content.membership.free.title}</h3>
                        <span className="text-3xl font-heading font-bold text-gray-600 dark:text-gray-400">{content.membership.free.price}</span>
                      </div>
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-4">
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.free.feature1}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.free.feature2}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.free.feature3}</li>
                        <li className="flex items-center gap-2"><span className="text-red-500">✗</span> {content.membership.free.feature4}</li>
                      </ul>
                      <p className="text-xs text-gray-600 dark:text-gray-400">{content.membership.free.bestFor}</p>
                    </div>

                    <div className="bg-gradient-to-r from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-6 border-2 border-blue-500">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">{content.membership.plus.title}</h3>
                        <span className="text-3xl font-heading font-bold text-blue-600">{content.membership.plus.price}</span>
                      </div>
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-4">
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.plus.feature1}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.plus.feature2}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.plus.feature3}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.plus.feature4}</li>
                      </ul>
                      <p className="text-xs text-gray-600 dark:text-gray-400">{content.membership.plus.bestFor}</p>
                    </div>

                    <div className="bg-gradient-to-r from-yellow-100 to-yellow-50 dark:from-yellow-900/30 dark:to-yellow-800/30 rounded-xl p-6 border-2 border-yellow-500 relative overflow-hidden">
                      <div className="absolute top-4 right-4 bg-yellow-500 text-white px-3 py-1 rounded-full text-xs font-heading font-bold">{content.membership.professional.badge}</div>
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">{content.membership.professional.title}</h3>
                        <span className="text-3xl font-heading font-bold text-yellow-600">{content.membership.professional.price}</span>
                      </div>
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-4">
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.professional.feature1}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.professional.feature2}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.professional.feature3}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.professional.feature4}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.professional.feature5}</li>
                      </ul>
                      <p className="text-xs text-gray-600 dark:text-gray-400">{content.membership.professional.bestFor}</p>
                    </div>

                    <div className="bg-gradient-to-r from-purple-100 to-purple-50 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-6 border-2 border-purple-500">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">{content.membership.premier.title}</h3>
                        <span className="text-3xl font-heading font-bold text-purple-600">{content.membership.premier.price}</span>
                      </div>
                      <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-4">
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.premier.feature1}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.premier.feature2}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.premier.feature3}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.premier.feature4}</li>
                        <li className="flex items-center gap-2"><span className="text-accent">✓</span> {content.membership.premier.feature5}</li>
                      </ul>
                      <p className="text-xs text-gray-600 dark:text-gray-400">{content.membership.premier.bestFor}</p>
                    </div>
                  </div>

                  <div className="mt-6 bg-accent/10 dark:bg-accent/20 rounded-xl p-6 border-l-4 border-accent">
                    <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                      <span>💡</span>
                      {content.membership.roiTitle}
                    </h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      {content.membership.roiText}
                    </p>
                  </div>
                </div>
              </section>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-8">
                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>💰</span>
                        {content.bidding.pricing.title}
                      </h3>
                      <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
                        {content.bidding.pricing.intro}
                      </p>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-6">
                        <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3">{content.bidding.pricing.approachTitle}</h4>
                        <div className="space-y-4">
                          <div className="border-l-4 border-accent pl-4">
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.pricing.tier1Title}</p>
                            <p className="text-sm text-gray-700 dark:text-gray-300">{content.bidding.pricing.tier1Text}</p>
                          </div>
                          <div className="border-l-4 border-primary pl-4">
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.pricing.tier2Title}</p>
                            <p className="text-sm text-gray-700 dark:text-gray-300">{content.bidding.pricing.tier2Text}</p>
                          </div>
                          <div className="border-l-4 border-secondary pl-4">
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.pricing.tier3Title}</p>
                            <p className="text-sm text-gray-700 dark:text-gray-300">{content.bidding.pricing.tier3Text}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>✍️</span>
                        {content.bidding.proposal.title}
                      </h3>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-6">
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">{content.bidding.proposal.copyText}</p>
                        <div className="space-y-4 text-sm">
                          <div>
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.proposal.greeting}</p>
                            <p className="text-gray-700 dark:text-gray-300 italic">{content.bidding.proposal.greetingExample}</p>
                          </div>
                          <div>
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.proposal.understanding}</p>
                            <p className="text-gray-700 dark:text-gray-300 italic">{content.bidding.proposal.understandingExample}</p>
                          </div>
                          <div>
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.proposal.solution}</p>
                            <p className="text-gray-700 dark:text-gray-300 italic">{content.bidding.proposal.solutionExample}</p>
                          </div>
                          <div>
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.proposal.proof}</p>
                            <p className="text-gray-700 dark:text-gray-300 italic">{content.bidding.proposal.proofExample}</p>
                          </div>
                          <div>
                            <p className="font-bold text-gray-900 dark:text-white mb-1">{content.bidding.proposal.cta}</p>
                            <p className="text-gray-700 dark:text-gray-300 italic">{content.bidding.proposal.ctaExample}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6">
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>🚀</span>
                        {content.bidding.tactics.title}
                      </h3>
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div>
                          <h4 className="font-heading font-bold text-accent mb-3">{content.bidding.tactics.doTitle}</h4>
                          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li>• {content.bidding.tactics.do1}</li>
                            <li>• {content.bidding.tactics.do2}</li>
                            <li>• {content.bidding.tactics.do3}</li>
                            <li>• {content.bidding.tactics.do4}</li>
                            <li>• {content.bidding.tactics.do5}</li>
                            <li>• {content.bidding.tactics.do6}</li>
                          </ul>
                        </div>
                        <div>
                          <h4 className="font-heading font-bold text-primary mb-3">{content.bidding.tactics.avoidTitle}</h4>
                          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li>• {content.bidding.tactics.avoid1}</li>
                            <li>• {content.bidding.tactics.avoid2}</li>
                            <li>• {content.bidding.tactics.avoid3}</li>
                            <li>• {content.bidding.tactics.avoid4}</li>
                            <li>• {content.bidding.tactics.avoid5}</li>
                            <li>• {content.bidding.tactics.avoid6}</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6">
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.fees.structure}</h3>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700">
                          <span className="text-gray-700 dark:text-gray-300">{content.fees.commission}</span>
                          <span className="font-heading font-bold text-primary">10%</span>
                        </div>
                        <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700">
                          <span className="text-gray-700 dark:text-gray-300">{content.fees.contest}</span>
                          <span className="font-heading font-bold text-primary">{currencySymbol}0-5</span>
                        </div>
                        <div className="flex justify-between items-center py-3 border-b border-gray-200 dark:border-gray-700">
                          <span className="text-gray-700 dark:text-gray-300">{content.fees.withdrawal}</span>
                          <span className="font-heading font-bold text-primary">1-3%</span>
                        </div>
                        <div className="flex justify-between items-center py-3">
                          <span className="text-gray-700 dark:text-gray-300">{content.fees.milestone}</span>
                          <span className="font-heading font-bold text-accent">{currencySymbol}0</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-accent/10 dark:bg-accent/20 rounded-xl p-6 border-l-4 border-accent">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                        <span>💡</span>
                        {content.fees.exampleTitle}
                      </h4>
                      <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                        {content.fees.exampleText}
                      </p>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm font-mono">
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.fees.examplePayment}</span>
                          <span className="text-gray-900 dark:text-white font-bold">{currencySymbol}1,000</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.fees.examplePlatform}</span>
                          <span className="text-red-600 dark:text-red-400">-{currencySymbol}100</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.fees.exampleWithdrawal}</span>
                          <span className="text-red-600 dark:text-red-400">-{currencySymbol}9</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                          <span className="text-gray-900 dark:text-white font-bold">{content.fees.exampleTakeHome}</span>
                          <span className="text-accent font-bold text-lg">{currencySymbol}891</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* Internal Links */}
              <section className="mb-16">
                <h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.links.title}</h2>
                <div className="grid sm:grid-cols-2 gap-6">
                  <Link href={`/${locale}/platforms`} className="group bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-primary/20">
                    <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-primary transition-colors">
                      {content.links.compare}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.links.compareText}
                    </p>
                  </Link>
                  <Link href={`/${locale}/reviews`} className="group bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.links.reviewsText}
                    </p>
                  </Link>
                  <Link href={`/${locale}/tools/rate-calculator`} className="group bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20">
                    <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">
                      {content.links.calculator}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.links.calculatorText}
                    </p>
                  </Link>
                  <Link href={`/${locale}/comparisons`} className="group bg-gradient-to-br from-accent/10 to-primary/10 dark:from-accent/20 dark:to-primary/20 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20">
                    <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-primary transition-colors">
                      {content.links.comparisons}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.links.comparisonsText}
                    </p>
                  </Link>
                </div>
              </section>
