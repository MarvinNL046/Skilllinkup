                  ...
                  <div>
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded p-4 text-sm mb-3">
                      <p className="text-orange-800">
                        <strong>⚠️ Warning:</strong> Read ToS carefully. Upwork bans circumvention. Fiverr penalizes off-platform communication. Violating rules can result in permanent account suspension.
                      </p>
                    </div>
                    <div className="bg-[#f8f9fb] rounded p-4 text-sm">
                      <p className="text-[#64607d]">
