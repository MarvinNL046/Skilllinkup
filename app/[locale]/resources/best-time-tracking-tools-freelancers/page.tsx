...
export async function generateMetadata({ params }: PageProps): Promise<Metadata>{
 ...
 const slug = 'best-time-tracking-tools-freelancers';
 ...
 images: [{ url: `${siteUrl}/images/og/resources-og.png`, width: 1200, height: 630, alt: 'Best Time Tracking Tools for Freelancers (Free and Paid)' }],
 locale: locale === 'nl' ? 'nl_NL' : 'en_US',
 type: 'article',
 },
 twitter: { card: 'summary_large_image', title: 'Best Time Tracking Tools for Freelancers (Free and Paid)', description: 'Compare top time tracking tools for freelancers with features, pricing, and reviews.', images: [`${siteUrl}/images/og/resources-og.png`], creator: '@SkillLinkup', site: '@SkillLinkup' },
...
export default async function TimeTrackingToolsPage({ params }: PageProps) {
 ...
 <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Use Consistent Categories</h3>
 <p className="text-gray-700 dark:text-gray-300 mb-4">
