...
export default async function ToptalForBeginnersPage({ params }: Props) {
 ...
 <article className="py-16 bg-gray-50 dark:bg-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">{/* Honest Answer */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.honestAnswer}
 </h2><p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">{content.honestAnswerText}
 </p></div></section>{/* Why Not Good for Beginners */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3"><span className="text-4xl">❌</span>{content.whyNotTitle}
 </h2><div className="grid sm:grid-cols-2 gap-6">{content.whyNotReasons.map((reason, idx) =>(
 <div key={idx} className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{reason.title}</h3><p className="text-sm text-gray-700 dark:text-gray-300">{reason.text}</p></div>))}
 </div></div></section>{/* What Toptal Wants */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.whatToptalWantsTitle}
 </h2><ul className="space-y-3">{content.whatToptalWants.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-3 text-gray-700 dark:text-gray-300"><span className="text-secondary text-xl mt-1">→</span><span>{item}</span></li>))}
 </ul></div></section>{/* What Top 3% Means */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.what3PercentMeansTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 mb-6">{content.what3PercentMeansText}</p><div className="space-y-4">{content.screeningFunnel.map((stage, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-lg p-4 border-l-4 border-secondary"><div className="flex items-center justify-between"><div><p className="font-heading font-bold text-gray-900 dark:text-white">{stage.stage}</p><p className="text-sm text-gray-600 dark:text-gray-400">{stage.rate}</p></div><div className="text-right"><p className="text-2xl font-heading font-bold text-secondary">{stage.cumulative}</p></div></div></div>))}
 </div><div className="mt-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border-l-4 border-yellow-500"><p className="text-sm text-gray-700 dark:text-gray-300"><strong>{locale === 'nl' ? 'Opmerking:' : 'Note:'}</strong>{content.screeningNote}
 </p></div></div></section>{/* Readiness Checklist */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3"><span className="text-4xl">✅</span>{content.readinessChecklistTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 mb-6">{content.readinessChecklistIntro}</p><div className="space-y-4">{content.readinessChecklist.map((item, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-lg p-4 border-l-4 border-primary"><p className="font-heading font-semibold text-gray-900 dark:text-white mb-1">{item.question}</p><p className="text-sm text-gray-600 dark:text-gray-400">{item.ready}</p></div>))}
 </div><div className="mt-6 bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border-l-4 border-red-500"><p className="text-sm text-gray-700 dark:text-gray-300"><strong></strong>{content.readinessNote}
 </p></div></div></section>{/* Better Alternatives */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.betterAlternativesTitle}
 </h2><div className="space-y-8">{content.betterAlternatives.map((alt, idx) =>(
 <div key={idx} className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-2">{alt.title}</h3><p className="text-sm text-gray-600 dark:text-gray-400 mb-4">{alt.description}</p><ul className="space-y-2 mb-4">{alt.features.map((feature, fidx) =>(
 <li key={fidx} className="flex items-start gap-2 text-gray-700 dark:text-gray-300 text-sm"><span className="text-green-600 mt-1">✓</span><span>{feature}</span></li>))}
 </ul><p className="text-sm text-gray-600 dark:text-gray-400 mb-4"><strong>{alt.ideal}</strong></p><Link
 ...
 >{alt.cta}
 <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg></Link></div>))}
 </div></div></section>{/* When to Apply */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3"><span className="text-4xl">⏰</span>{content.whenToApplyTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 mb-6">{content.whenToApplyIntro}</p><ul className="space-y-3 mb-6">{content.whenToApplyList.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-3 text-gray-700 dark:text-gray-300"><span className="text-accent text-xl mt-1">→</span><span>{item}</span></li>))}
 </ul><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-4 border-l-4 border-accent"><p className="text-sm text-gray-700 dark:text-gray-300"><strong>{locale === 'nl' ? 'Tip:' : 'Tip:'}</strong>{content.whenToApplyNote}
 </p></div></div></section>{/* Progression Path */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.progressionPathTitle}
 </h2><div className="space-y-6">{content.progressionPath.map((stage, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 rounded-xl p-6 border-l-4 border-primary"><div className="flex items-start justify-between mb-4"><div><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white">{stage.stage}</h3><p className="text-sm text-gray-600 dark:text-gray-400">{stage.platforms}</p></div><div className="text-right"><p className="text-sm font-heading font-bold text-accent">{stage.target}</p></div></div><ul className="space-y-2">{stage.focus.map((item, fidx) =>(
 <li key={fidx} className="flex items-start gap-2 text-gray-700 dark:text-gray-300 text-sm"><span className="text-primary mt-1">•</span><span>{item}</span></li>))}
 </ul></div>))}
 </div></div></section>{/* Real-World Advice */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.realWorldAdviceTitle}
 </h2><div className="space-y-6">{content.realWorldAdvice.map((item, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><p className="text-gray-700 dark:text-gray-300 italic mb-3">{item.advice}</p><p className="text-sm text-gray-600 dark:text-gray-400 font-semibold">— {item.author}</p></div>))}
 </div></div></section>{/* Bottom Line */}
 <section className="mb-16"><div className="bg-gradient-to-br from-secondary/10 via-primary/10 to-accent/10 dark:from-secondary/20 dark:via-primary/20 dark:to-accent/20 rounded-2xl shadow-lg p-8 border-2 border-secondary/30 dark:border-secondary/50"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.bottomLineTitle}
 </h2><p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.bottomLineText}
 </p><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.actionPlanTitle}</h3><ul className="space-y-3">{content.actionPlan.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-3 text-gray-700 dark:text-gray-300"><span className="text-secondary text-xl mt-1">→</span><span>{item}</span></li>))}
 </ul></div></section>{/* Related Resources */}
 <section className="mb-16"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.relatedResources}</h2><div className="grid sm:grid-cols-2 gap-6"><Link href={`/${locale}/resources/upwork-complete-guide`} className="group bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.upworkGuide}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.upworkGuideText}
 </p></Link><Link href={`/${locale}/resources/fiverr-beginner-guide`} className="group bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-accent transition-colors">{content.fiverrGuide}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.fiverrGuideText}
 </p></Link><Link href={`/${locale}/resources/toptal-review`} className="group bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-primary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-primary transition-colors">{content.toptalReview}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.toptalReviewText}
 </p></Link><Link href={`/${locale}/resources/freelance-beginners-guide`} className="group bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.freelanceBeginners}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.freelanceBeginnersText}
