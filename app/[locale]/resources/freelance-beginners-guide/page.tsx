  ...
  return (
    <>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-primary/10 via-white to-accent/10 dark:from-secondary dark:via-gray-900 dark:to-gray-800 py-16 sm:py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/20 dark:bg-primary/30 text-primary dark:text-accent text-sm font-semibold mb-6">
            ...
            <div className="max-w-4xl mx-auto prose prose-lg dark:prose-invert">
              ...
              <div className="mb-12">
                ...
                <div className="bg-gradient-to-br from-primary/5 to-accent/5 dark:from-primary/10 dark:to-accent/10 rounded-2xl p-6 my-6 border border-primary/20 dark:border-primary/30">
                  <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.step1.skillsTitle}</h3>
                  <div className="grid md:grid-cols-2 gap-3">
                    {content.step1.skills.map((skill, i) => (
                      <div key={i} className="flex items-start gap-2">
                        <span className="text-primary text-lg mt-1">▸</span>
                        <div>
                          <strong className="text-gray-900 dark:text-white">{skill.title}</strong>
                          <span className="text-gray-700 dark:text-gray-300"> {skill.desc}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 dark:border-yellow-500 p-6 my-6 rounded-r-xl">
                  <p className="text-gray-800 dark:text-gray-200 font-semibold mb-2">💡 {content.step1.proTip.split(':')[0]}:</p>
                  <p className="text-gray-700 dark:text-gray-300">
                    {content.step1.proTip.split(':').slice(1).join(':')}
                  </p>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-3 mb-6">
                  {content.step2.criteria.map((item, i) => (
                ...
                <div className="bg-gradient-to-br from-secondary/5 to-primary/5 dark:from-secondary/10 dark:to-primary/10 rounded-2xl p-6 my-6 border border-secondary/20 dark:border-secondary/30">
                  <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.step2.platformsTitle}</h3>
                  <div className="space-y-4">
                    {content.step2.platforms.map((platform, i) => (
                      <div key={i} className="border-l-4 border-primary pl-4">
                        <h4 className="font-bold text-gray-900 dark:text-white mb-1">{platform.name}</h4>
                        <p className="text-gray-700 dark:text-gray-300">{platform.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  {content.step2.recommendation}
                </p>
              </div>

              {/* CTA 1 */}
              <div className="my-12 bg-gradient-to-r from-primary via-primary/90 to-accent rounded-2xl p-8 text-center shadow-xl">
              ...
              <div className="mb-12">
                ...
                <div className="space-y-6 mb-6">
                  {content.step3.elements.map((element, i) => (
                    <div key={i}>
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3">{element.title}</h3>
                      <p className="text-gray-700 dark:text-gray-300 mb-2">{element.desc}</p>
                    </div>
                  ))}
                </div>
              ...
              <div className="mb-12">
                ...
                <div className="bg-gradient-to-br from-accent/10 to-primary/10 dark:from-accent/20 dark:to-primary/20 rounded-2xl p-6 my-6 border border-accent/20 dark:border-accent/30">
                  <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.step4.strategyTitle}</h3>
                  <div className="space-y-4">
                    {content.step4.phases.map((phase, i) => (
                      <div key={i}>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border-l-4 border-red-400 dark:border-red-500 p-6 my-6 rounded-r-xl">
                  <p className="text-gray-800 dark:text-gray-200 font-semibold mb-2">⚠️ {content.step4.warning.split('.')[0]}</p>
                  <p className="text-gray-700 dark:text-gray-300">
                    {content.step4.warning.split('.').slice(1).join('.')}
                  </p>
                </div>

                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  {content.step4.researchTip}
                </p>
              </div>
