...
export default async function IsToptalLegitPage({ params }: Props) {
 ...
 <section className="py-12 bg-white dark:bg-gray-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-8 shadow-lg border-2 border-green-200 dark:border-green-800"><h2 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3"><span className="text-3xl">✅</span>{content.quickAnswer}
 </h2><div className="bg-white dark:bg-gray-900 rounded-xl p-6 mb-4"><p className="text-3xl font-heading font-bold text-green-600 dark:text-green-400 mb-4">{content.quickAnswerYes}
 </p><ul className="space-y-2 text-gray-700 dark:text-gray-300">{content.quickAnswerPoints.map((point, idx) =>(
 <li key={idx}>{point}</li>))}
 </ul></div><div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-4 border-l-4 border-yellow-500"><p className="font-semibold text-gray-900 dark:text-white mb-2">{content.butImportant}</p><p className="text-sm text-gray-700 dark:text-gray-300">{content.warningPoint}</p></div></div></div></div></section>{/* Main Content */}
 <article className="py-16 bg-gray-50 dark:bg-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">{/* Trust Signals */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.trustSignals}
 </h2>{/* Established History */}
 <div className="mb-8"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.established}
 </h3><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{content.establishedText}
 </p><div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border-l-4 border-blue-500"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.proofPoints}</p><ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">{content.establishedPoints.map((point, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-blue-600 mt-1">→</span><span>{point}</span></li>))}
 </ul></div></div>{/* Fortune 500 Clients */}
 <div className="mb-8"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.fortune500}
 </h3><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{content.fortune500Text}
 </p><div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 border-l-4 border-purple-500"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.confirmedClients}</p><ul className="grid sm:grid-cols-2 gap-3 text-gray-700 dark:text-gray-300 text-sm mb-4">{content.clientsList.map((client, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-purple-600 mt-1">✓</span><span>{client}</span></li>))}
 </ul><p className="text-xs text-gray-600 dark:text-gray-400 italic">{content.impossibleScam}</p></div></div>{/* Secure Payments */}
 <div className="mb-8"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.securePayments}
 </h3><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{content.securePaymentsText}
 </p><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-l-4 border-green-500"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.paymentProtections}</p><ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">{content.protectionsList.map((point, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-green-600 mt-1">→</span><span>{point}</span></li>))}
 </ul></div></div>{/* Real Freelancer Reviews */}
 <div><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.realFreelancers}
 </h3><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{content.realFreelancersText}
 </p><div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border-l-4 border-yellow-500 mb-4"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.reviewBreakdown}</p><div className="space-y-3 text-sm"><div className="bg-white dark:bg-gray-900 rounded-lg p-3 border-l-4 border-green-500"><p className="font-semibold text-gray-900 dark:text-white">{content.bbb}</p><p className="text-green-600 dark:text-green-400 font-bold">{content.bbbScore}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-semibold text-gray-900 dark:text-white">{content.trustpilot}</p><p className="text-gray-600 dark:text-gray-400">{content.trustpilotScore}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-semibold text-gray-900 dark:text-white">{content.glassdoor}</p><p className="text-gray-600 dark:text-gray-400">{content.glassdoorScore}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-semibold text-gray-900 dark:text-white">{content.reddit}</p><p className="text-gray-600 dark:text-gray-400">{content.redditScore}</p></div></div></div><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-l-4 border-green-500"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.commonThemes}</p><ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">{content.positiveThemes.map((theme, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-green-600 mt-1">✓</span><span>{theme}</span></li>))}
 </ul></div></div></div></section>{/* Rigorous Screening */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.rigorous}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.rigorousText}
 </p><div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border-l-4 border-blue-500 mb-4"><p className="font-semibold text-gray-900 dark:text-white mb-3">{content.screeningSteps}</p><ol className="space-y-2 text-gray-700 dark:text-gray-300 text-sm list-decimal list-inside"><li>{content.step1}</li><li>{content.step2}</li><li>{content.step3}</li><li>{content.step4}</li><li>{content.step5}</li></ol></div><div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border-l-4 border-green-500"><p className="text-sm text-gray-700 dark:text-gray-300 italic">{content.scamWouldnt}</p></div></div></section>{/* Red Flags Section */}
 <section className="mb-16"><div className="bg-red-50 dark:bg-red-900/20 rounded-2xl shadow-lg p-8 border-2 border-red-200 dark:border-red-800"><h2 className="text-3xl font-heading font-bold text-red-800 dark:text-red-300 mb-6 flex items-center gap-3">{content.redFlags}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.redFlagsIntro}
 </p><div className="space-y-6"><div className="bg-white dark:bg-gray-900 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span>❌</span>{content.scamSign1}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.scamSign1Text}</p></div><div className="bg-white dark:bg-gray-900 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.scamSign2}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.scamSign2Text}</p></div><div className="bg-white dark:bg-gray-900 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.scamSign3}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.scamSign3Text}</p></div><div className="bg-white dark:bg-gray-900 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.scamSign4}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.scamSign4Text}</p></div><div className="bg-white dark:bg-gray-900 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.scamSign5}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.scamSign5Text}</p></div></div></div></section>{/* Verification Steps */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3"><span className="text-4xl">✅</span>{content.verify}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.verifyIntro}
 </p><div className="space-y-4"><div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border-l-4 border-blue-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span className="bg-blue-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">1</span>{content.verifyStep1}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.verifyStep1Text}</p></div><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-l-4 border-green-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span className="bg-green-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">2</span>{content.verifyStep2}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.verifyStep2Text}</p></div><div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 border-l-4 border-purple-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span className="bg-purple-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">3</span>{content.verifyStep3}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.verifyStep3Text}</p></div><div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border-l-4 border-yellow-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span className="bg-yellow-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">4</span>{content.verifyStep4}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.verifyStep4Text}</p></div><div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2"><span className="bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">5</span>{content.verifyStep5}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.verifyStep5Text}</p></div></div></div></section>{/* Real Concerns */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.realConcerns}
 ...
 <div key={idx} className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-xl p-6 border-l-4 border-gray-400"><h3 className="text-lg font-heading font-bold text-gray-900 dark:text-white mb-3">{item.concern}
 </h3><p className="text-sm text-gray-600 dark:text-gray-400 mb-2"><strong>{item.valid}</strong>{item.answer}
 </p></div>))}
 </div></div></section>{/* Known Issues & Legal Controversies */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.knownIssues}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.knownIssuesIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border-l-4 border-blue-500"><h3 className="text-lg font-heading font-bold text-gray-900 dark:text-white mb-3">{content.lawsuit2026}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.lawsuit2026Text}
 </p></div><div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 border-l-4 border-purple-500"><h3 className="text-lg font-heading font-bold text-gray-900 dark:text-white mb-3">{content.lawsuitAndela}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.lawsuitAndelaText}
 </p></div><div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border-l-4 border-yellow-500"><h3 className="text-lg font-heading font-bold text-gray-900 dark:text-white mb-3">{content.qualityVariance}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{content.qualityVarianceText}
 </p></div></div></div></section>{/* Final Verdict */}
 <section className="mb-16"><div className="bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-green-900/20 dark:via-blue-900/20 dark:to-purple-900/20 rounded-2xl shadow-lg p-8 border-2 border-green-200 dark:border-green-800"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.finalVerdict}
 </h2><div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed"><p className="text-lg"><strong className="text-gray-900 dark:text-white">{content.legitimacy}</strong>{content.legitimacyText}
 </p><div className="bg-white dark:bg-gray-900 rounded-xl p-6"><p className="text-lg mb-2"><strong className="text-gray-900 dark:text-white">{content.worthIt}</strong></p><p className="mb-2"><strong className="text-green-600 dark:text-green-400">{content.forElite}</strong>{content.forEliteText}
 </p><p><strong className="text-red-600 dark:text-red-400">{content.forBeginner}</strong>{content.forBeginnerText}
 </p></div><div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-xl p-6 border-l-4 border-yellow-500"><p className="text-lg mb-2"><strong className="text-gray-900 dark:text-white">{content.trustButVerify}</strong></p><p>{content.trustButVerifyText}</p></div><p className="text-lg"><strong className="text-gray-900 dark:text-white">{content.bottomLine}</strong>{content.bottomLineText}
 </p></div></div></section>{/* Compare Options */}
 <section className="mb-16"><div className="bg-gradient-to-r from-secondary to-primary rounded-2xl p-8 text-center shadow-2xl"><h3 className="text-2xl sm:text-3xl font-heading font-bold text-white mb-4">{content.compareOptions}
 </h3><p className="text-white/90 mb-6 max-w-2xl mx-auto">{content.compareOptionsText}
 </p><Link
 href={`/${locale}/platforms`}
 ...
 <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg></Link></div></section>{/* Internal Links */}
 <section className="mb-16"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.exploreMore}</h2><div className="grid sm:grid-cols-2 gap-6"><Link href={`/${locale}/platforms`} className="group bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 hover:shadow-lg transition-all border border-green-200 dark:border-green-800"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-green-600 transition-colors">{content.viewAllPlatforms}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.viewAllPlatformsText}
 </p></Link><Link href={`/${locale}/reviews`} className="group bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 hover:shadow-lg transition-all border border-blue-200 dark:border-blue-800"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-blue-600 transition-colors">{content.readReviews}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.readReviewsText}
 </p></Link><Link href={`/${locale}/tools/rate-calculator`} className="group bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-6 hover:shadow-lg transition-all border border-purple-200 dark:border-purple-800"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 transition-colors">{content.calculateRate}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.calculateRateText}
 </p></Link><Link href={`/${locale}/resources`} className="group bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 hover:shadow-lg transition-all border border-yellow-200 dark:border-yellow-800"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-yellow-600 transition-colors">{content.scamGuide}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.scamGuideText}
 </p></Link></div></section></div></div></article>{/* Final CTA */}
 <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center"><h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.needHelp}
 </h2><p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">{content.needHelpText}
 </p><div className="flex flex-wrap justify-center gap-4"><Link
 href={`/${locale}/platforms`}
