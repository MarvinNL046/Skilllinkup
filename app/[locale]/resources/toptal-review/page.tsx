              ...
              <div className="bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-2xl p-8 shadow-lg">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="text-center">
                    <div className="text-6xl font-heading font-bold text-secondary dark:text-accent mb-2">4.5/5</div>
                    <div className="flex justify-center gap-1 mb-3">
                      {[1, 2, 3, 4].map((star) => (
                        <span key={star} className="text-yellow-400 text-2xl">★</span>
                      ))}
                      <span className="text-yellow-400 text-2xl opacity-50">★</span>
                    </div>
                    <p className="text-gray-700 dark:text-gray-300 font-heading font-semibold">{content.overallRating}</p>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">{content.clientQuality}</span>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">{content.earningsPotential}</span>
                      <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <span key={star} className="text-yellow-400">★</span>
                        ))}
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">{content.easeOfEntry}</span>
                      <div className="flex gap-1">
                        {[1, 2].map((star) => (
                          <span key={star} className="text-yellow-400">★</span>
                        ))}
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-700 dark:text-gray-300">{content.supportQuality}</span>
                      <div className="flex gap-1">
                        {[1, 2, 3, 4].map((star) => (
                          <span key={star} className="text-yellow-400">★</span>
                        ))}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                    {content.whatMakesDifferentText}
                  </p>
                  ...
                  <div className="grid sm:grid-cols-3 gap-6 mb-8">
                    <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 text-center border border-secondary/20">
                      ...
                      <div className="text-2xl font-heading font-bold text-secondary mb-2">3%</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">{content.acceptanceRate}</div>
                    </div>
                    <div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 text-center border border-accent/20">
                      <div className="text-4xl mb-3">💼</div>
                      <div className="text-2xl font-heading font-bold text-accent mb-2">{devRateRange}</div>
                      <div className="text-sm text-gray-600 dark:text-gray-400">{content.avgHourlyRate}</div>
                    </div>
                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 text-center border border-primary/20">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">{content.enterpriseClients}</div>
                    </div>
                  </div>
                    ...
                    <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                      {content.valueProps.map((prop, idx) => (
                        <li key={idx} className="flex items-start gap-3">
                          ...
                          <div><strong className="text-gray-900 dark:text-white">{prop.title}</strong> {prop.text}</div>
                        </li>
                      ))}
                    </ul>
                  </div>
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  <h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                    <span className="text-4xl">🚪</span>
                    {content.screeningProcess}
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                    {content.screeningIntro}
                  </p>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.step1PassRate}</strong> ~70%</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.step1Time}</strong> 1 {locale === 'nl' ? 'uur' : 'hour'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 border-l-4 border-accent">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.step2PassRate}</strong> ~25%</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.step2Time}</strong> 1,5 {locale === 'nl' ? 'uur' : 'hours'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6 border-l-4 border-secondary">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.step3PassRate}</strong> ~15%</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.step3Time}</strong> 15-30 {locale === 'nl' ? 'uur' : 'hours'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-accent/5 dark:from-primary/10 dark:to-accent/10 rounded-xl p-6 border-l-4 border-primary">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.step4PassRate}</strong> ~10%</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.step4Time}</strong> 1 {locale === 'nl' ? 'uur' : 'hour'}</p>
                          </div>
                        </div>
                      </div>
                    </div>

                    <div className="bg-gradient-to-br from-accent/5 to-secondary/5 dark:from-accent/10 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-accent">
                      <div className="flex items-start gap-4">
                        <div className="bg-accent text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">5</div>
                        <div className="flex-1">
                          <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step5Title}</h3>
                          <p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
                            {content.step5Text}
                          </p>
                          <div className="bg-white dark:bg-gray-900 rounded-lg p-3">
                            <p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.step5PassRate}</strong> ~3-5% ({locale === 'nl' ? 'cumulatief' : 'cumulative'})</p>
                            <p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.step5Time}</strong> 80-160 {locale === 'nl' ? 'uur' : 'hours'}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-8 bg-red-50 dark:bg-red-900/20 rounded-xl p-6 border-l-4 border-red-500">
                    <h4 className="font-heading font-bold text-red-800 dark:text-red-300 mb-3 flex items-center gap-2">
                      <span>⚠️</span>
                      {content.rejectionNote}
                    </h4>
                    <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                      {content.rejectionPoints.map((point, idx) => (
                        <li key={idx}>• {point}</li>
                      ))}
                    </ul>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border border-accent/20">
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>📊</span>
                        {content.typicalRates}
                      </h3>
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.developers}</p>
                          <p className="text-2xl font-heading font-bold text-accent">{devRateRange}</p>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.designers}</p>
                          <p className="text-2xl font-heading font-bold text-accent">{designerRateRange}</p>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.financeExperts}</p>
                          <p className="text-2xl font-heading font-bold text-accent">{financeRateRange}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border border-primary/20">
                      ...
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.standardProjects}</p>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                          ...
                          <p className="text-xl font-heading font-bold text-primary">~15-25%</p>
                        </div>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent">
                    <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                      <span>💡</span>
                      {content.earningsExample}
                    </h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                      {content.earningsExampleText}
                    </p>
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm font-mono">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">{content.grossBillings}</span>
                        <span className="text-gray-900 dark:text-white font-bold">{grossAmount}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">{content.toptalFee}</span>
                        <span className="text-red-600 dark:text-red-400">{feeAmount}</span>
                      </div>
                      <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                        <span className="text-gray-900 dark:text-white font-bold">{content.yourTakeHome}</span>
                        <span className="text-accent font-bold text-lg">{netAmount}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent">
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>✅</span>
                        {content.greatFitTitle}
                      </h3>
                      <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                        {content.greatFitList.map((item, idx) => (
                    ...
                    <div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary">
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <span>⚠️</span>
                        {content.considerAlternativesTitle}
                      </h3>
                      <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <section className="mb-16">
                <div className="bg-gradient-to-br from-secondary/10 via-primary/10 to-accent/10 dark:from-secondary/20 dark:via-primary/20 dark:to-accent/20 rounded-2xl shadow-lg p-8 border-2 border-secondary/30 dark:border-secondary/50">
                  ...
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                    <p className="text-lg">
                      <strong className="text-gray-900 dark:text-white">{content.verdictElite}</strong> {content.verdictEliteText}
                    </p>
                    <p className="text-lg">
                      <strong className="text-gray-900 dark:text-white">{content.verdictMidLevel}</strong> {content.verdictMidLevelText}
                    </p>
                    <p className="text-lg">
                      <strong className="text-gray-900 dark:text-white">{content.verdictBottomLine}</strong> {content.verdictBottomLineText}
                    </p>
                  </div>
                  <div className="mt-6 bg-white dark:bg-gray-900 rounded-xl p-6 text-center">
                    <div className="text-5xl font-heading font-bold text-secondary dark:text-accent mb-2">4.5/5</div>
                    <p className="text-gray-600 dark:text-gray-400">{content.excellentForElite}</p>
                  </div>
                </div>
              </section>
