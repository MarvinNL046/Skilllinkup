...
export default async function WhatIsUpworkPage({ params }: Props) {
 ...
 </p><div className="flex flex-wrap justify-center gap-4"><a
 ...
 >{content.cta1}
 <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg></a><Link
 ...
 >{content.cta2}
 </Link></div></div></div></section>{/* Quick Answer */}
 <section className="py-12 bg-white dark:bg-gray-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-2xl p-8 shadow-lg"><h2 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.quickAnswerTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">{content.quickAnswer}
 </p><div className="grid sm:grid-cols-3 gap-6 mt-8"><div className="bg-white dark:bg-gray-900 rounded-xl p-4 text-center"><div className="text-2xl font-heading font-bold text-secondary mb-1">May 2015</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.foundedYear}</div></div><div className="bg-white dark:bg-gray-900 rounded-xl p-4 text-center"><div className="text-2xl font-heading font-bold text-accent mb-1">18M+</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.activeFreelancers}</div></div><div className="bg-white dark:bg-gray-900 rounded-xl p-4 text-center"><div className="text-2xl font-heading font-bold text-primary mb-1">$769M</div><div className="text-sm text-gray-600 dark:text-gray-400">2024 Revenue</div></div></div></div></div></div></section>{/* Main Content */}
 <article className="py-16 bg-gray-50 dark:bg-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">{/* How It Works */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.howItWorksTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.howItWorksIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6 border-l-4 border-primary"><div className="flex items-start gap-4"><div className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">1</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step1Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step1Text}
 </p></div></div></div><div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 border-l-4 border-accent"><div className="flex items-start gap-4"><div className="bg-accent text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">2</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step2Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step2Text}
 </p></div></div></div><div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6 border-l-4 border-secondary"><div className="flex items-start gap-4"><div className="bg-secondary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">3</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step3Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step3Text}
 </p></div></div></div><div className="bg-gradient-to-br from-primary/5 to-accent/5 dark:from-primary/10 dark:to-accent/10 rounded-xl p-6 border-l-4 border-primary"><div className="flex items-start gap-4"><div className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">4</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step4Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step4Text}
 </p></div></div></div></div><div className="mt-8 grid sm:grid-cols-2 gap-4"><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-4 border border-secondary/20"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.forFreelancers}</h4><p className="text-sm text-gray-600 dark:text-gray-400">{locale === 'nl' ? 'Bied je diensten aan, vind klanten, en verdien geld' : 'Offer your services, find clients, and earn money'}</p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-4 border border-accent/20"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.forClients}</h4><p className="text-sm text-gray-600 dark:text-gray-400">{locale === 'nl' ? 'Post projecten, vind talent, en krijg werk gedaan' : 'Post projects, find talent, and get work done'}</p></div></div></div></section>{/* Job Types */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.jobTypesTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.jobTypesIntro}
 </p><div className="space-y-4"><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category1}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category1Jobs}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category2}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category2Jobs}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category3}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category3Jobs}
 </p></div><div className="bg-gradient-to-r from-primary/10 to-accent/5 dark:from-primary/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category4}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category4Jobs}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-primary/5 dark:from-secondary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category5}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category5Jobs}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-secondary/5 dark:from-accent/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">{content.category6}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.category6Jobs}
 </p></div></div></div></section>{/* Fee Structure */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.feeStructureTitle}
 </h2><div className="mb-8"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.freelancerFeesTitle}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-6">{content.freelancerFeesIntro}
 </p><div className="grid md:grid-cols-3 gap-4 mb-6"><div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800"><p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{content.feeFirst500}</p><p className="text-3xl font-heading font-bold text-blue-600 dark:text-blue-400">0-15%</p></div><div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800"><p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{content.feeNext500}</p><p className="text-3xl font-heading font-bold text-purple-600 dark:text-purple-400">Variable</p></div><div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-4 border border-green-200 dark:border-green-800"><p className="text-sm text-gray-600 dark:text-gray-400 mb-2">{content.feeAbove10k}</p><p className="text-3xl font-heading font-bold text-green-600 dark:text-green-400">Activity</p></div></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.feeExample}
 </h4><p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{content.feeExampleText}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm font-mono"><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.feeCalc1}</span><span className="text-gray-900 dark:text-white font-bold">{fee1}</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.feeCalc2}</span><span className="text-gray-900 dark:text-white font-bold">{fee2}</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.feeCalc3}</span><span className="text-gray-900 dark:text-white font-bold">{fee3}</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-red-600 dark:text-red-400 font-bold">{content.feeTotalFee}</span><span className="text-red-600 dark:text-red-400 font-bold">{totalFee}</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-accent font-bold">{content.feeYourEarnings}</span><span className="text-accent font-bold text-lg">{netEarnings}</span></div></div></div></div><div className="mb-8"><h4 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.additionalCostsTitle}</h4><div className="space-y-3"><div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4"><p className="font-semibold text-gray-900 dark:text-white mb-1">{content.costConnects}</p><p className="text-sm text-gray-600 dark:text-gray-400">{content.costConnectsText}</p></div><div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4"><p className="font-semibold text-gray-900 dark:text-white mb-1">{content.costMembership}</p><p className="text-sm text-gray-600 dark:text-gray-400">{content.costMembershipText}</p></div><div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4"><p className="font-semibold text-gray-900 dark:text-white mb-1">{content.costWithdrawal}</p><p className="text-sm text-gray-600 dark:text-gray-400">{content.costWithdrawalText}</p></div></div></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h4 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3">{content.clientCostsTitle}</h4><p className="text-gray-700 dark:text-gray-300 text-sm">{content.clientCostsText}
 </p></div></div></section>{/* Pros & Cons */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.prosConsTitle}
 </h2><div className="grid md:grid-cols-2 gap-8"><div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800"><h3 className="text-2xl font-heading font-bold text-green-800 dark:text-green-300 mb-6 flex items-center gap-2"><span>✅</span>{content.prosTitle}
 </h3><ul className="space-y-4">{content.prosItems.map((pro, idx) =>(
 <li key={idx} className="flex items-start gap-3"><span className="text-green-600 text-xl mt-1">→</span><div><strong className="text-gray-900 dark:text-white block mb-1">{pro.title}</strong><span className="text-sm text-gray-700 dark:text-gray-300">{pro.text}</span></div></li>))}
 </ul></div><div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-2 border-red-200 dark:border-red-800"><h3 className="text-2xl font-heading font-bold text-red-800 dark:text-red-300 mb-6 flex items-center gap-2"><span>❌</span>{content.consTitle}
 </h3><ul className="space-y-4">{content.consItems.map((con, idx) =>(
 <li key={idx} className="flex items-start gap-3"><span className="text-red-600 text-xl mt-1">→</span><div><strong className="text-gray-900 dark:text-white block mb-1">{con.title}</strong><span className="text-sm text-gray-700 dark:text-gray-300">{con.text}</span></div></li>))}
 </ul></div></div></div></section>{/* How to Get Started */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.howToStartTitle}
 </h2><div className="space-y-6"><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><span className="bg-primary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">1</span>{content.startStep1Title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.startStep1Text}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><span className="bg-accent text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">2</span>{content.startStep2Title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.startStep2Text}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><span className="bg-secondary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">3</span>{content.startStep3Title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.startStep3Text}
 </p></div><div className="bg-gradient-to-r from-primary/10 to-accent/5 dark:from-primary/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><span className="bg-primary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">4</span>{content.startStep4Title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.startStep4Text}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-primary/5 dark:from-secondary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2"><span className="bg-secondary text-white rounded-full w-8 h-8 flex items-center justify-center text-sm">5</span>{content.startStep5Title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.startStep5Text}
 </p></div></div></div></section>{/* Who Uses Upwork */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.whoUsesTitle}
 </h2><div className="space-y-6"><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.freelancersSection}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.freelancersText}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.clientsSection}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.clientsText}
 </p></div></div></div></section>{/* Is Right For You */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.isRightTitle}
 </h2><div className="space-y-6"><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-l-4 border-green-500"><h3 className="text-xl font-heading font-bold text-green-800 dark:text-green-300 mb-4 flex items-center gap-2"><span>✅</span>{content.goodFitTitle}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.goodFitItems.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-green-600 mt-1">→</span><span className="text-sm">{item}</span></li>))}
 </ul></div><div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-red-800 dark:text-red-300 mb-4 flex items-center gap-2"><span>❌</span>{content.notGoodTitle}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.notGoodItems.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-red-600 mt-1">→</span><span className="text-sm">{item}</span></li>))}
 </ul></div></div></div></section>{/* Pro Tips */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.tipsTitle}
 </h2><div className="space-y-4">{content.tipsItems.map((tip, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{tip.title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{tip.text}
 </p></div>))}
 </div></div></section>{/* Upwork vs Alternatives */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.upworkVsTitle}
 </h2><div className="space-y-4"><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{content.upworkVsFiverr}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.upworkVsFiverrText}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{content.upworkVsFreelancer}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.upworkVsFreelancerText}
 </p></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">{content.upworkVsToptal}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.upworkVsToptalText}
 </p></div></div></div></section>{/* Final Thoughts */}
 <section className="mb-16"><div className="bg-gradient-to-br from-secondary/10 via-primary/10 to-accent/10 dark:from-secondary/20 dark:via-primary/20 dark:to-accent/20 rounded-2xl shadow-lg p-8 border-2 border-secondary/30 dark:border-secondary/50"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.finalThoughtsTitle}
 </h2><div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed"><p className="text-lg">{content.finalThoughtsText}
 </p><p className="text-lg">{content.bestForText}
 </p><p className="text-lg"><strong className="text-gray-900 dark:text-white">{content.bottomLineTitle}</strong>{content.bottomLineText}
 </p></div></div></section>{/* Internal Links */}
 <section className="mb-16"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.exploreMore}</h2><div className="grid sm:grid-cols-2 gap-6"><a href="https://www.upwork.com" target="_blank" rel="noopener noreferrer" className="group bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.visitUpwork}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.visitUpworkText}
 </p></a><Link href={`/${locale}/platforms`} className="group bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-accent transition-colors">{content.compareAllPlatforms}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.compareAllPlatformsText}
 </p></Link><Link href={`/${locale}/resources/upwork-complete-guide`} className="group bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-primary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-primary transition-colors">{content.upworkGuide}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.upworkGuideText}
 </p></Link><Link href={`/${locale}/tools/rate-calculator`} className="group bg-gradient-to-br from-secondary/10 to-accent/10 dark:from-secondary/20 dark:to-accent/20 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.calculateYourRate}
 ...
 <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center"><h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.readyTitle}
 </h2><p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">{content.readyText}
