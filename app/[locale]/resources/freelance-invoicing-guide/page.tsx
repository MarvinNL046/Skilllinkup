...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }>}): Promise<Metadata>{
 ...
 const slug = 'freelance-invoicing-guide';
 ...
 images: [{ url: `${siteUrl}/images/og/resources-og.png`, width: 1200, height: 630, alt: 'Facturen maken als ZZP\'er: Sjablonen & Best Practices 2024' }],
 locale: 'nl_NL',
 type: 'article',
 },
 twitter: {
 ...
 url: pageUrl,
 siteName: 'SkillLinkup',
 images: [{ url: `${siteUrl}/images/og/resources-og.png`, width: 1200, height: 630, alt: 'Freelance Invoicing Guide: Templates & Best Practices 2024' }],
 locale: 'en_US',
 type: 'article',
 },
 twitter: {
