...
export default async function WhatIsToptalPage({ params }: Props) {
 ...
 <section className="py-12 bg-white dark:bg-gray-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="grid grid-cols-2 md:grid-cols-4 gap-6"><div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 text-center border border-secondary/20"><div className="text-2xl font-heading font-bold text-secondary mb-1">2010</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.foundedYear}</div></div><div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 text-center border border-accent/20"><div className="text-2xl font-heading font-bold text-accent mb-1">Fully Remote</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.headquartered}</div></div><div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 text-center border border-primary/20"><div className="text-2xl font-heading font-bold text-primary mb-1">3%</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.acceptance}</div></div><div className="bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-xl p-6 text-center border border-secondary/20"><div className="text-2xl font-heading font-bold text-secondary mb-1">10,000+</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.talentCount}</div></div></div></div></div></section>{/* Main Content */}
 <article className="py-16 bg-gray-50 dark:bg-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">{/* Introduction */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.introTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">{content.introText}
 </p></div></section>{/* How It Works */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.howItWorksSectionTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.howItWorksIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6 border-l-4 border-secondary"><div className="flex items-start gap-4"><div className="bg-secondary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">1</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step1Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step1Text}
 ...
 </p></div></div></div><div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6 border-l-4 border-primary"><div className="flex items-start gap-4"><div className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">3</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step3Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step3Text}
 </p></div></div></div><div className="bg-gradient-to-br from-secondary/5 to-primary/5 dark:from-secondary/10 dark:to-primary/10 rounded-xl p-6 border-l-4 border-secondary"><div className="flex items-start gap-4"><div className="bg-secondary text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">4</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.step4Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.step4Text}
 </p></div></div></div></div></div></section>{/* Who Gets Accepted */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.whoGetsAcceptedTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.whoGetsAcceptedIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.category1}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-3">{content.category1Text}
 </p><p className="text-sm text-gray-600 dark:text-gray-400 italic">{content.category1Examples}
 </p></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.category2}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-3">{content.category2Text}
 </p><p className="text-sm text-gray-600 dark:text-gray-400 italic">{content.category2Examples}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.category3}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-3">{content.category3Text}
 </p><p className="text-sm text-gray-600 dark:text-gray-400 italic">{content.category3Examples}
 </p></div><div className="bg-gradient-to-r from-accent/10 to-primary/5 dark:from-accent/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.category4}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-3">{content.category4Text}
 </p><p className="text-sm text-gray-600 dark:text-gray-400 italic">{content.category4Examples}
 </p></div><div className="bg-gradient-to-r from-secondary/10 to-accent/5 dark:from-secondary/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.category5}
 </h3><p className="text-gray-700 dark:text-gray-300 mb-3">{content.category5Text}
 </p><p className="text-sm text-gray-600 dark:text-gray-400 italic">{content.category5Examples}
 </p></div></div></div></section>{/* Different from Others */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.differentFromOthersTitle}
 </h2><div className="space-y-6"><div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6"><h3 className="text-xl font-heading font-bold text-secondary mb-3">{content.vsUpwork}</h3><p className="text-gray-700 dark:text-gray-300">{content.vsUpworkText}
 </p></div><div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6"><h3 className="text-xl font-heading font-bold text-accent mb-3">{content.vsFiverr}</h3><p className="text-gray-700 dark:text-gray-300">{content.vsFiverrText}
 </p></div><div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6"><h3 className="text-xl font-heading font-bold text-primary mb-3">{content.vsFreelancer}</h3><p className="text-gray-700 dark:text-gray-300">{content.vsFreelancerText}
 </p></div><div className="bg-gradient-to-br from-secondary/5 to-primary/5 dark:from-secondary/10 dark:to-primary/10 rounded-xl p-6"><h3 className="text-xl font-heading font-bold text-secondary mb-3">{content.vsGun}</h3><p className="text-gray-700 dark:text-gray-300">{content.vsGunText}
 </p></div></div></div></section>{/* Matching Process */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.matchingProcessTitle}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.matchingProcessIntro}
 ...
 <div key={idx} className="bg-gradient-to-r from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-lg font-heading font-bold text-gray-900 dark:text-white mb-2">{idx + 1}. {item.title}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm">{item.text}
 </p></div>))}
 </div></div></section>{/* Benefits */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3"><span className="text-4xl">✅</span>{content.benefitsTitle}
 ...
 <div key={idx} className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border border-green-200 dark:border-green-800"><h3 className="text-lg font-heading font-bold text-green-800 dark:text-green-300 mb-2">{benefit.title}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{benefit.text}
 </p></div>))}
 </div></div></section>{/* Challenges */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.challengesTitle}
 ...
 <div key={idx} className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-lg font-heading font-bold text-red-800 dark:text-red-300 mb-2">{challenge.title}
 </h3><p className="text-sm text-gray-700 dark:text-gray-300">{challenge.text}
 </p></div>))}
 </div></div></section>{/* Is It Worth It */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.isItWorthTitle}
 </h2><div className="space-y-6"><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"><span>✅</span>{content.worthItFor}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.worthItList.map((item, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-accent mt-1">→</span><span>{item}</span></li>))}
 </ul></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.considerAlternatives}
 ...
 </ul></div></div></div></section>{/* Bottom Line */}
 <section className="mb-16"><div className="bg-gradient-to-br from-secondary/10 via-primary/10 to-accent/10 dark:from-secondary/20 dark:via-primary/20 dark:to-accent/20 rounded-2xl shadow-lg p-8 border-2 border-secondary/30 dark:border-secondary/50"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.bottomLine}
 </h2><div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed"><p className="text-lg">{content.bottomLineText}
 </p><p className="text-lg font-heading font-semibold text-gray-900 dark:text-white">{content.bottomLineCTA}
 </p></div></div></section>{/* Internal Links */}
 <section className="mb-16"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.exploreMore}</h2><div className="grid sm:grid-cols-2 gap-6"><Link href={`/${locale}/resources/toptal-review`} className="group bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.readFullReview}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.readFullReviewText}
 </p></Link><Link href={`/${locale}/platforms`} className="group bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-accent transition-colors">{content.compareAllPlatforms}
 ...
 <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center"><h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.finalCTATitle}
