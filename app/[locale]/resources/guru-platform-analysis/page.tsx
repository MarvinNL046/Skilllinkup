...
export default async function GuruPlatformAnalysisPage({ params }: Props) {
 ...
 <section className="bg-gradient-to-br from-accent/10 via-white to-secondary/10 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-16 sm:py-24"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center"><div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/20 dark:bg-accent/30 text-accent dark:text-accent mb-6"><span className="text-sm font-heading font-semibold">{content.hero.badge}</span></div><h1 className="text-4xl sm:text-5xl lg:text-6xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.hero.title}
 </h1><p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">{content.hero.description}
 ...
 >{content.hero.cta2}
 </Link></div></div></div></section>{/* Key Stats */}
 <section className="py-12 bg-white dark:bg-gray-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="grid sm:grid-cols-4 gap-6"><div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 text-center border border-accent/20"><div className="text-3xl font-heading font-bold text-accent mb-2">3M+</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.stats.freelancers}</div></div><div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 text-center border border-primary/20"><div className="text-3xl font-heading font-bold text-primary mb-2">250K+</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.stats.employers}</div></div><div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 text-center border border-secondary/20"><div className="text-3xl font-heading font-bold text-secondary mb-2">$250M+</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.stats.revenue}</div></div><div className="bg-gradient-to-br from-accent/10 to-primary/10 dark:from-accent/20 dark:to-primary/20 rounded-xl p-6 text-center border border-primary/20"><div className="text-3xl font-heading font-bold text-accent mb-2">4.2/5</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.stats.rating}</div></div></div></div></div></section>{/* Main Content */}
 ...
 </p><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.overview.philosophy.title}
 </h3><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">{content.overview.philosophy.description}
 </p><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.overview.philosophy.features.map((feature, index) =>(
 <li key={index} className="flex items-start gap-3"><span className="text-accent text-xl mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{feature.label}</strong>{feature.text}</div></li>))}
 </ul></div><div className="grid sm:grid-cols-2 gap-6"><div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.overview.services.title}
 </h4><ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">{content.overview.services.items.map((item, index) =>(
 <li key={index}>• {item}</li>))}
 </ul></div><div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.overview.bestFor.title}
 </h4><ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">{content.overview.bestFor.items.map((item, index) =>(
 <li key={index}>• {item}</li>))}
 </ul></div></div></div></section>{/* SafePay Feature */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.safepay.title}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.safepay.intro}
 </p><div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 border-l-4 border-accent mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.safepay.howItWorks.title}</h3><ol className="space-y-4 text-gray-700 dark:text-gray-300">{content.safepay.howItWorks.steps.map((step, index) =>(
 <li key={index} className="flex items-start gap-3"><span className="font-bold text-accent">{index + 1}.</span><div><strong className="text-gray-900 dark:text-white">{step.label}</strong>{step.text}</div></li>))}
 </ol></div><div className="grid sm:grid-cols-2 gap-6"><div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800"><h4 className="font-heading font-bold text-green-800 dark:text-green-300 mb-3 flex items-center gap-2"><span>✅</span>{content.safepay.advantages.title}
 </h4><ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">{content.safepay.advantages.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-2"><span className="text-green-600">→</span><span>{item}</span></li>))}
 </ul></div><div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-800"><h4 className="font-heading font-bold text-blue-800 dark:text-blue-300 mb-3 flex items-center gap-2">{content.safepay.bestPractices.title}
 </h4><ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">{content.safepay.bestPractices.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-2"><span className="text-blue-600">→</span><span>{item}</span></li>))}
 </ul></div></div></div></section>{/* WorkRooms Feature */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.workrooms.title}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.workrooms.intro}
 </p><div className="space-y-6"><div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.workrooms.components.title}
 </h3><div className="grid sm:grid-cols-2 gap-4">{content.workrooms.components.items.map((item, index) =>(
 <div key={index} className="bg-white dark:bg-gray-900 rounded-lg p-4"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-2 text-sm">{index === 0 && ""} {index === 1 && ""} {index === 2 && ""} {index === 3 && ""} {index === 4 && ""} {index === 5 && ""} {item.title}
 </h4><p className="text-xs text-gray-700 dark:text-gray-300">{item.text}</p></div>))}
 </div></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.workrooms.whyMatters.title}
 </h4><p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">{content.workrooms.whyMatters.description}
 </p><ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">{content.workrooms.whyMatters.benefits.map((benefit, index) =>(
 <li key={index} className="flex items-start gap-2"><span className="text-accent">✓</span><span>{benefit}</span></li>))}
 </ul></div></div></div></section>{/* CTA Mid-Article */}
 <div className="mb-16"><div className="bg-gradient-to-r from-accent to-secondary rounded-2xl p-8 text-center shadow-2xl"><h3 className="text-2xl sm:text-3xl font-heading font-bold text-white mb-4">{content.ctaMid.title}
 </h3><p className="text-white/90 mb-6 max-w-2xl mx-auto">{content.ctaMid.description}
 </p><Link
 href={`/${locale}/platforms`}
 ...
 >{content.ctaMid.cta}
 <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg></Link></div></div>{/* Pricing Tiers */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.pricing.title}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.pricing.intro}
 </p><div className="space-y-6">{content.pricing.tiers.map((tier, index) =>(
 <div
 key={index}
 ...
 >{tier.badge && (
 <div className="absolute top-4 right-4 bg-yellow-500 text-white px-3 py-1 rounded-full text-xs font-heading font-bold">{tier.badge}
 </div>)}
 <div className="flex items-center justify-between mb-4"><h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">{tier.name}</h3><span className={`text-3xl font-heading font-bold ${
 tier.badge ? "text-yellow-600" : index === 1 ? "text-blue-600" : "text-gray-600 dark:text-gray-400"
 }`}>{tier.price}
 </span></div><ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm mb-4">{tier.features.map((feature, fIndex) =>(
 <li key={fIndex} className="flex items-center gap-2"><span className={feature.included ? "text-accent" : "text-red-500"}>{feature.included ? "✓" : "✗"}
 </span>{feature.text}
 </li>))}
 </ul><p className="text-xs text-gray-600 dark:text-gray-400">{locale === "nl" ? "Het beste voor: " : "Best for: "}{tier.bestFor}
 </p></div>))}
 </div><div className="mt-8 bg-gradient-to-r from-primary/10 to-accent/10 dark:from-primary/20 dark:to-accent/20 rounded-xl p-6"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.pricing.roi.title}</h4><p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{content.pricing.roi.description}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm font-mono"><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.pricing.roi.labels.target}</span><span className="text-gray-900 dark:text-white font-bold">{content.pricing.roi.calculation.target}</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.pricing.roi.labels.basicFee}</span><span className="text-red-600 dark:text-red-400">{content.pricing.roi.calculation.basicFee}</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.pricing.roi.labels.businessFee}</span><span className="text-gray-700 dark:text-gray-300">{content.pricing.roi.calculation.businessFee}</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.pricing.roi.labels.membership}</span><span className="text-gray-700 dark:text-gray-300">{content.pricing.roi.calculation.membership}</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-gray-900 dark:text-white font-bold">{content.pricing.roi.labels.savings}</span><span className="text-accent font-bold text-lg">{content.pricing.roi.calculation.savings}</span></div></div><p className="text-xs text-gray-600 dark:text-gray-400 mt-3">{content.pricing.roi.note}
 </p></div></div></section>{/* Ideal User Profiles */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.idealUsers.title}
 </h2><div className="space-y-6"><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2"><span>✅</span>{content.idealUsers.perfect.title}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.idealUsers.perfect.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-3"><span className="text-accent text-xl mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{item.label}</strong>{item.text}
 </div></li>))}
 </ul></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.idealUsers.alternatives.title}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300">{content.idealUsers.alternatives.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-3"><span className="text-primary text-xl mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{item.label}</strong>{item.text}
 </div></li>))}
 </ul></div></div></div></section>{/* Pros & Cons */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-8 flex items-center gap-3">{content.proscons.title}
 </h2><div className="grid md:grid-cols-2 gap-8"><div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800"><h3 className="text-2xl font-heading font-bold text-green-800 dark:text-green-300 mb-6 flex items-center gap-2"><span>✅</span>{content.proscons.pros.title}
 </h3><ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">{content.proscons.pros.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-2"><span className="text-green-600">✓</span><span><strong>{item.label}</strong>{item.text}</span></li>))}
 </ul></div><div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-2 border-red-200 dark:border-red-800"><h3 className="text-2xl font-heading font-bold text-red-800 dark:text-red-300 mb-6 flex items-center gap-2"><span>❌</span>{content.proscons.cons.title}
 </h3><ul className="space-y-3 text-sm text-gray-700 dark:text-gray-300">{content.proscons.cons.items.map((item, index) =>(
 <li key={index} className="flex items-start gap-2"><span className="text-red-600">✗</span><span><strong>{item.label}</strong>{item.text}</span></li>))}
 </ul></div></div></div></section>{/* Final Verdict */}
 <section className="mb-16"><div className="bg-gradient-to-br from-accent/10 via-primary/10 to-secondary/10 dark:from-accent/20 dark:via-primary/20 dark:to-secondary/20 rounded-2xl shadow-lg p-8 border-2 border-accent/30 dark:border-accent/50"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.verdict.title}
 </h2><div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed"><p className="text-lg"><strong className="text-gray-900 dark:text-white">{locale === "nl" ? "Voor ervaren professionals die kwaliteitsklanten zoeken:" : "For experienced professionals seeking quality clients:"}
 </strong>{" "}
 {content.verdict.experienced}
 </p><p className="text-lg"><strong className="text-gray-900 dark:text-white">{locale === "nl" ? "Voor beginners of internationale freelancers:" : "For beginners or international freelancers:"}
 </strong>{" "}
 {content.verdict.beginners}
 </p><p className="text-lg"><strong className="text-gray-900 dark:text-white">{locale === "nl" ? "Strategische aanpak:" : "Strategic approach:"}
 </strong>{" "}
 {content.verdict.strategic}
 </p></div><div className="mt-6 bg-white dark:bg-gray-900 rounded-xl p-6 text-center"><div className="text-5xl font-heading font-bold text-accent mb-2">4.2/5</div><p className="text-gray-600 dark:text-gray-400">{content.verdict.rating}</p></div></div></section>{/* Internal Links */}
 <section className="mb-16"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.explore.title}</h2><div className="grid sm:grid-cols-2 gap-6">{content.explore.links.map((link, index) =>(
 <Link
 key={index}
 ...
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{link.description}
 </p></Link>))}
 </div></section></div></div></article>{/* Final CTA */}
 ...
 </h2><p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">{content.finalCta.description}
 </p><div className="flex flex-wrap justify-center gap-4"><Link
 href={`/${locale}/platforms`}
