...
export default async function ToptalPricingPage({ params }: Props) {
  ...
  const content = locale === 'nl' ? {
    badge: "Toptal Tarieven & Kosten 2025",
    ...
    badge: "Toptal Rates & Pricing 2025",
  ...
  const jsonLd = {
    ...
    "@type": "Article",
    "headline": locale === 'nl' ? "Toptal Kosten 2025: Hoeveel Kost Toptal?" : "Toptal Pricing 2025: How Much Does Toptal Cost?",
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-2xl p-8 border border-accent/20">
                  <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                    <span>👨‍💻</span>
                    {content.forFreelancers}
                  </h3>
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.typicalRates}</p>
                      <p className="text-2xl font-heading font-bold text-accent">$60-150+/hr</p>
                    </div>
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.platformFees}</p>
                      <p className="text-2xl font-heading font-bold text-green-600">0% {locale === 'nl' ? '(Gratis!)' : '(Free!)'}</p>
                    </div>
                  </div>
                </div>

                <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-2xl p-8 border border-primary/20">
                  <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                    <span>🏢</span>
                    {content.forClients}
                  </h3>
                  <div className="space-y-3">
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.typicalRates}</p>
                      <p className="text-2xl font-heading font-bold text-primary">$78-225+/hr</p>
                    </div>
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.platformFees}</p>
                      <p className="text-2xl font-heading font-bold text-primary">30-50% {locale === 'nl' ? 'opslag' : 'markup'}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary">
                    ...
                    <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                      {content.keyPointsList.map((point, idx) => (
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  <h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                    <span className="text-4xl">👨‍💻</span>
                    {content.freelancerRates}
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                    {content.freelancerIntro}
                  </p>

                  {/* Developer Rates */}
                  <div className="mb-8">
                    <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                      💻 {content.developerRates}
                    </h3>

                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6 mb-6">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.devByExperience}</h4>
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.juniorDev}</span>
                          <span className="text-xl font-heading font-bold text-accent">$60-80/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.midDev}</span>
                          <span className="text-xl font-heading font-bold text-accent">$70-100/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.seniorDev}</span>
                          <span className="text-xl font-heading font-bold text-accent">$80-120/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.specializedDev}</span>
                          <span className="text-xl font-heading font-bold text-accent">$100-200+/hr</span>
                        </div>
                      </div>
                    </div>

                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 dark:from-primary/10 dark:to-primary/20 rounded-xl p-6">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.devByStack}</h4>
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.webDev}</span>
                          <span className="text-xl font-heading font-bold text-primary">$70-120/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.backendDev}</span>
                          <span className="text-xl font-heading font-bold text-primary">$75-130/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.mobileDev}</span>
                          <span className="text-xl font-heading font-bold text-primary">$80-140/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.blockchainDev}</span>
                          <span className="text-xl font-heading font-bold text-primary">$100-180/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.aiDev}</span>
                          <span className="text-xl font-heading font-bold text-primary">$120-200+/hr</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="bg-gradient-to-br from-secondary/5 to-secondary/10 dark:from-secondary/10 dark:to-secondary/20 rounded-xl p-6">
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.uiuxDesigner}</span>
                          <span className="text-xl font-heading font-bold text-secondary">$50-100/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.productDesigner}</span>
                          <span className="text-xl font-heading font-bold text-secondary">$60-120/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.visualDesigner}</span>
                          <span className="text-xl font-heading font-bold text-secondary">$50-90/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.motionDesigner}</span>
                          <span className="text-xl font-heading font-bold text-secondary">$60-110/hr</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="bg-gradient-to-br from-accent/5 to-accent/10 dark:from-accent/10 dark:to-accent/20 rounded-xl p-6">
                      <div className="space-y-3">
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.projectManager}</span>
                          <span className="text-xl font-heading font-bold text-accent">$60-120/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.productManager}</span>
                          <span className="text-xl font-heading font-bold text-accent">$70-140/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.financeExpert}</span>
                          <span className="text-xl font-heading font-bold text-accent">$100-250/hr</span>
                        </div>
                        <div className="bg-white dark:bg-gray-900 rounded-lg p-4 flex justify-between items-center">
                          <span className="text-gray-700 dark:text-gray-300">{content.businessAnalyst}</span>
                          <span className="text-xl font-heading font-bold text-accent">$60-120/hr</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.example1Title}</h4>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example1Rate}</span>
                          <span className="text-gray-900 dark:text-white font-bold">$82/hr</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example1Hours}</span>
                          <span className="text-gray-900 dark:text-white font-bold">40 {locale === 'nl' ? 'uur' : 'hours'}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example1Duration}</span>
                          <span className="text-gray-900 dark:text-white font-bold">6 {locale === 'nl' ? 'maanden' : 'months'}</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                          <span className="text-gray-600 dark:text-gray-400">{content.example1Gross}</span>
                          <span className="text-gray-900 dark:text-white font-bold">$78,720</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example1ToptalFee}</span>
                          <span className="text-green-600 dark:text-green-400 font-bold">$0 (0%)</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                          <span className="text-gray-900 dark:text-white font-bold">{content.example1TakeHome}</span>
                          <span className="text-accent font-bold text-lg">$78,720</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary">
                      <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4">{content.example2Title}</h4>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example2Rate}</span>
                          <span className="text-gray-900 dark:text-white font-bold">$80/hr</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example2Hours}</span>
                          <span className="text-gray-900 dark:text-white font-bold">30 {locale === 'nl' ? 'uur' : 'hours'}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example2Duration}</span>
                          <span className="text-gray-900 dark:text-white font-bold">4 {locale === 'nl' ? 'maanden' : 'months'}</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                          <span className="text-gray-600 dark:text-gray-400">{content.example2Gross}</span>
                          <span className="text-gray-900 dark:text-white font-bold">$38,400</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600 dark:text-gray-400">{content.example2ToptalFee}</span>
                          <span className="text-green-600 dark:text-green-400 font-bold">$0 (0%)</span>
                        </div>
                        <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                          <span className="text-gray-900 dark:text-white font-bold">{content.example2TakeHome}</span>
                          <span className="text-accent font-bold text-lg">$38,400</span>
                        </div>
                      </div>
                    </div>
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 mb-8">
                    <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                      📊 {content.clientFeeStructure}
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                      {content.clientFeeNote}
                    </p>
                    <div className="space-y-3">
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.standardEngagements}</p>
                        <p className="text-xl font-heading font-bold text-primary">~30-40%</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.longTermContracts}</p>
                        <p className="text-xl font-heading font-bold text-primary">~25-35%</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.enterpriseDeals}</p>
                        <p className="text-xl font-heading font-bold text-primary">~20-30%</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent mb-8">
                    <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                      <span>💡</span>
                      {content.clientExample}
                    </h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                      {locale === 'nl' ? 'Een bedrijf huurt een senior ontwikkelaar voor €82/uur gedurende 6 maanden (40 uur/week):' : 'A company hires a senior developer at $82/hr for 6 months (40 hours/week):'}
                    </p>
                    <div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 text-sm font-mono">
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">{content.freelancerPays}</span>
                        <span className="text-gray-900 dark:text-white font-bold">$82/hr × 960hr = $78,720</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">{content.toptalMarkup}</span>
                        <span className="text-orange-600 dark:text-orange-400">+$39,360 (50%)</span>
                      </div>
                      <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
                        <span className="text-gray-900 dark:text-white font-bold">{content.totalClientCost}</span>
                        <span className="text-accent font-bold text-lg">$118,080</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600 dark:text-gray-400">{content.monthlyCost}</span>
                        <span className="text-primary font-bold">$19,680/mo</span>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border border-secondary/20">
                    <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                      💳 {content.depositRequirements}
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">
                      {locale === 'nl' ? 'Toptal vereist dat klanten een vooruitbetaling doen voordat werk begint. Freelancers betalen ook platform kosten:' : 'Toptal requires clients to make an upfront payment before work begins. Freelancers also pay platform fees:'}
                    </p>
                    <div className="space-y-3">
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{locale === 'nl' ? 'Client Deposit (Terugbetaalbaar)' : 'Client Deposit (Refundable)'}</p>
                        <p className="text-lg font-heading font-bold text-secondary">$500 {locale === 'nl' ? 'minimum' : 'minimum'}</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{locale === 'nl' ? 'Freelancer Platform Abonnement' : 'Freelancer Platform Subscription'}</p>
                        <p className="text-lg font-heading font-bold text-secondary">$79/{locale === 'nl' ? 'maand' : 'month'}</p>
                      </div>
                      <div className="bg-white dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{locale === 'nl' ? 'Minimum Uren Requirement' : 'Minimum Hours Requirement'}</p>
                        <p className="text-lg font-heading font-bold text-secondary">20+ {locale === 'nl' ? 'uur/week' : 'hrs/week'}</p>
                      </div>
                    </div>
                  </div>
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  <h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">
                    <span className="text-4xl">📊</span>
                    {content.comparisonWithPlatforms}
                  </h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead className="bg-gradient-to-r from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20">
                        <tr>
                          <th className="text-left p-4 font-heading font-bold text-gray-900 dark:text-white">{content.platform}</th>
                          <th className="text-left p-4 font-heading font-bold text-gray-900 dark:text-white">{content.freelancerFees}</th>
                          <th className="text-left p-4 font-heading font-bold text-gray-900 dark:text-white">{content.typicalHourly}</th>
                          <th className="text-left p-4 font-heading font-bold text-gray-900 dark:text-white">{content.clientMarkup}</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        <tr className="hover:bg-secondary/5 dark:hover:bg-secondary/10 transition-colors">
                          <td className="p-4 font-heading font-bold text-secondary">{content.toptal}</td>
                          <td className="p-4 text-green-600 dark:text-green-400 font-bold">{content.noFees}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.toptalRates}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.clientPays}</td>
                        </tr>
                        <tr className="hover:bg-accent/5 dark:hover:bg-accent/10 transition-colors">
                          <td className="p-4 font-heading font-bold text-accent">{content.upwork}</td>
                          <td className="p-4 text-orange-600 dark:text-orange-400">{content.upworkFees}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.upworkRates}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.upworkNoFee}</td>
                        </tr>
                        <tr className="hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors">
                          <td className="p-4 font-heading font-bold text-primary">{content.fiverr}</td>
                          <td className="p-4 text-red-600 dark:text-red-400">{content.fiverrrFees}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.fiverrRates}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.fiverrNoFee}</td>
                        </tr>
                        <tr className="hover:bg-secondary/5 dark:hover:bg-secondary/10 transition-colors">
                          <td className="p-4 font-heading font-bold">{content.freelancerCom}</td>
                          <td className="p-4 text-orange-600 dark:text-orange-400">{content.freelancerComFees}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.freelancerComRates}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.freelancerNoFee}</td>
                        </tr>
                        <tr className="hover:bg-accent/5 dark:hover:bg-accent/10 transition-colors">
                          <td className="p-4 font-heading font-bold">{content.guru}</td>
                          <td className="p-4 text-yellow-600 dark:text-yellow-400">{content.guruFees}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.guruRates}</td>
                          <td className="p-4 text-gray-700 dark:text-gray-300">{content.guruNoFee}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>

                  <div className="mt-8 bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent">
                    ...
                    <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <span>{content.takeaway1}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <span>{content.takeaway2}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <span>{content.takeaway3}</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <span className="text-accent text-xl mt-1">→</span>
                        <span>{content.takeaway4}</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border border-accent/20">
                      <h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                        👨‍💻 {content.freelancerPayments}
                      </h3>
                      <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="text-accent mt-1">✓</span>
                          <span>{content.biWeeklyPayouts}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-accent mt-1">✓</span>
                          <span>{locale === 'nl' ? 'Net 10 betalingstermijn (10 dagen)' : 'Net 10 payment terms (10 days)'}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-accent mt-1">✓</span>
                          <span>{content.paymentCurrency}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-accent mt-1">✓</span>
                          <span>{content.noPaymentRisk}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-accent mt-1">✓</span>
                          <span>{content.invoicingHandled}</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border border-primary/20">
                      ...
                      <ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                        <li className="flex items-start gap-2">
                          ...
                          <span>{content.monthlyInvoices}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">✓</span>
                          <span>{locale === 'nl' ? 'Accepteert: Credit cards, ACH, wire, PayPal' : 'Accepts: Credit cards, ACH, wire, PayPal'}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">✓</span>
                          <span>{locale === 'nl' ? 'Net 10 betalingstermijn' : 'Net 10 payment terms'}</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-primary mt-1">✓</span>
                          <span>{content.automaticTracking}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <section className="mb-16">
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                  ...
                  <div className="space-y-6 mb-8">
                    <div>
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                        {content.forFreelancersDecision}
                      </h3>

                      <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent mb-4">
                        <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                          <span>✅</span>
                          {content.freelancersYes}
                        </h4>
                        <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                          {content.freelancersYesList.map((item, idx) => (
                      ...
                      <div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary">
                        <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                          <span>⚠️</span>
                          {content.freelancersNo}
                        </h4>
                        <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                          {content.freelancersNoList.map((item, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                              <span className="text-primary mt-1">→</span>
                              <span>{item}</span>
                            </li>
                    ...
                    <div>
                      <h3 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-4">
                        {content.forClientsDecision}
                      </h3>

                      <div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary mb-4">
                        <h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">
                          <span>✅</span>
                          {content.clientsYes}
                        </h4>
                        <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                          {content.clientsYesList.map((item, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                      ...
                      <div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent">
                        ...
                        <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
                          {content.clientsNoList.map((item, idx) => (
                            <li key={idx} className="flex items-start gap-2">
                              <span className="text-accent mt-1">→</span>
                              <span>{item}</span>
                            </li>
              ...
              <section className="mb-16">
                <div className="bg-gradient-to-br from-secondary/10 via-primary/10 to-accent/10 dark:from-secondary/20 dark:via-primary/20 dark:to-accent/20 rounded-2xl shadow-lg p-8 border-2 border-secondary/30 dark:border-secondary/50">
                  ...
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                    <p className="text-lg">{content.finalText1}</p>
                    <p className="text-lg">{content.finalText2}</p>
                    <p className="text-lg">{content.finalText3}</p>
                    <p className="text-lg">
              ...
              <section className="mb-16">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  ...
                  <Link href={`/${locale}/tools/rate-calculator`} className="group bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 hover:shadow-lg transition-all border border-accent/20">
                    <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-accent transition-colors">
                      {content.rateCalculator}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.rateCalculatorText}
                    </p>
                  </Link>
                  <Link href={`/${locale}/resources/upwork-vs-toptal`} className="group bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 hover:shadow-lg transition-all border border-primary/20">
                  ...
                  <Link href={`/${locale}/platforms`} className="group bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20">
                    <h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">
                      {content.allPlatforms}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">
                      {content.allPlatformsText}
                    </p>
                  </Link>
                </div>
              </section>
