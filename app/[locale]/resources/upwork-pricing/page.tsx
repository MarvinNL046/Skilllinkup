...
export default async function UpworkPricingPage({ params }: Props) {
 ...
 >{content.cta2}
 </Link></div></div></div></section>{/* Overall Pricing Overview */}
 <section className="py-12 bg-white dark:bg-gray-800"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto"><div className="bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-2xl p-8 shadow-lg"><h2 className="text-2xl font-heading font-bold text-gray-900 dark:text-white mb-6 text-center">{content.overallPricing}</h2><div className="grid md:grid-cols-4 gap-6"><div className="text-center"><div className="text-3xl font-heading font-bold text-secondary dark:text-accent mb-1">0-15%</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.freelancerFees}</div></div><div className="text-center"><div className="text-3xl font-heading font-bold text-accent mb-1">~8%</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.clientFees}</div></div><div className="text-center"><div className="text-3xl font-heading font-bold text-primary mb-1">$0.15</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.connectsCost}</div></div><div className="text-center"><div className="text-3xl font-heading font-bold text-secondary mb-1">$19.99</div><div className="text-sm text-gray-600 dark:text-gray-400">{content.subscriptionValue}</div></div></div></div></div></div></section>{/* Main Content */}
 <article className="py-16 bg-gray-50 dark:bg-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto">{/* What is Upwork Pricing */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.whatIsUpworkPricing}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.whatIsUpworkPricingText}
 </p><div className="grid md:grid-cols-2 gap-6"><div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border border-accent/20"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.freelancersPayFor}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">{content.freelancerCosts.map((cost, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-accent mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{cost.title}</strong>{cost.text}</div></li>))}
 </ul></div><div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border border-primary/20"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.clientsPayFor}
 </h3><ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">{content.clientCosts.map((cost, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-primary mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{cost.title}</strong>{cost.text}</div></li>))}
 </ul></div></div></div></section>{/* Freelancer Fee Structure - Sliding Scale */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.freelancerFeeStructure}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.freelancerFeeIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><div className="flex items-start gap-4"><div className="bg-red-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">1</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.tier1Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-3">{content.tier1Text}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.tier1Fee}</strong>0-15% (variable)</p><p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.tier1Example}</strong>$1,000 project at 12% → $120 fee → $880 net</p></div></div></div></div><div className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-xl p-6 border-l-4 border-yellow-500"><div className="flex items-start gap-4"><div className="bg-yellow-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">2</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.tier2Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-3">{content.tier2Text}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.tier2Fee}</strong>10% (flat)</p><p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.tier2Example}</strong>$5,000 enterprise project → $500 fee → $4,500 net</p></div></div></div></div><div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-l-4 border-green-500"><div className="flex items-start gap-4"><div className="bg-green-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-heading font-bold flex-shrink-0">3</div><div className="flex-1"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.tier3Title}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-3">{content.tier3Text}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-600 dark:text-gray-400 mb-1"><strong>{content.tier3Fee}</strong>0% (FREE!)</p><p className="text-xs text-gray-600 dark:text-gray-400"><strong>{content.tier3Example}</strong>$2,000 Direct Contract → $0 fee → $2,000 net</p></div></div></div></div></div><div className="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500"><h4 className="font-heading font-bold text-blue-800 dark:text-blue-300 mb-3 flex items-center gap-2">{content.criticalNote}
 </h4><ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">{content.criticalPoints.map((point, idx) =>(
 <li key={idx}>• {point}</li>))}
 ...
 <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg></Link></div></div>{/* Connects System */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.connectsSystem}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.connectsIntro}
 </p><div className="mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.connectsPricing}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{content.connectsPricingText}
 </p><div className="grid md:grid-cols-3 gap-4"><div className="bg-gradient-to-br from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-lg p-4 border border-accent/20"><p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.freeConnects}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.freeConnectsText}</p></div><div className="bg-gradient-to-br from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-lg p-4 border border-primary/20"><p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.purchasedConnects}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.purchasedConnectsText}</p></div><div className="bg-gradient-to-br from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-lg p-4 border border-secondary/20"><p className="text-sm text-gray-500 dark:text-gray-400 mb-1">{content.costPerProposal}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.costPerProposalText}</p></div></div></div><div className="mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.connectsCalculation}
 </h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{content.connectsCalculationText}
 </p><div className="space-y-3"><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-4 border-l-4 border-green-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.simpleJobs}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.simpleJobsText}</p></div><div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-lg p-4 border-l-4 border-yellow-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.standardJobs}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.standardJobsText}</p></div><div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-lg p-4 border-l-4 border-red-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.complexJobs}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.complexJobsText}</p></div></div></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">{content.connectsTips}
 </h4><ul className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">{content.connectsTipsList.map((tip, idx) =>(
 <li key={idx} className="flex items-start gap-2"><span className="text-accent mt-1">→</span><div><strong className="text-gray-900 dark:text-white">{tip.title}</strong>{tip.text}</div></li>))}
 </ul></div></div></section>{/* Client Fees */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.clientFeesExplained}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.clientFeesIntro}
 </p><div className="space-y-6"><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3">{content.marketplaceFee}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-3">{content.marketplaceFeeText}
 </p><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-600 dark:text-gray-400 font-mono">{content.marketplaceFeeExample}</p></div></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3">{content.paymentProcessing}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-3">{content.paymentProcessingText}
 </p><div className="grid md:grid-cols-3 gap-3"><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{content.creditCardFee}</p><p className="text-sm text-gray-700 dark:text-gray-300">{content.creditCardFeeText}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{content.achFee}</p><p className="text-sm text-gray-700 dark:text-gray-300">{content.achFeeText}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{content.paypalFee}</p><p className="text-sm text-gray-700 dark:text-gray-300">{content.paypalFeeText}</p></div></div></div><div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-l-4 border-red-500"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-3">{content.contractToHireFee}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.contractToHireFeeText}
 </p></div></div></div></section>{/* Freelancer Plus */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.freelancerPlusBreakdown}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.freelancerPlusIntro}
 </p><div className="mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.plusBenefits}</h3><div className="space-y-3">{content.plusBenefitsList.map((benefit, idx) =>(
 <div key={idx} className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-lg p-4 border-l-4 border-accent"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{benefit.title}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{benefit.text}</p></div>))}
 </div></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.worthItCalculation}</h3><p className="text-gray-700 dark:text-gray-300 text-sm mb-4">{content.worthItCalculationText}
 </p><div className="space-y-3"><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.lowBidder}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.lowBidderText}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.moderateBidder}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.moderateBidderText}</p></div><div className="bg-white dark:bg-gray-900 rounded-lg p-3"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.activeBidder}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.activeBidderText}</p></div></div></div></div></section>{/* Withdrawal Fees */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.withdrawalFees}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.withdrawalIntro}
 </p><div className="mb-8"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-4">{content.withdrawalMethods}</h3><div className="space-y-3"><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-4 border-l-4 border-green-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.directToUSBank}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.directToUSBankText}</p></div><div className="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-4 border-l-4 border-blue-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.payoneer}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.payoneerText}</p></div><div className="bg-gradient-to-r from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 rounded-lg p-4 border-l-4 border-yellow-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.paypalWithdrawal}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.paypalWithdrawalText}</p></div><div className="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-lg p-4 border-l-4 border-red-500"><p className="font-heading font-bold text-gray-900 dark:text-white mb-1">{content.wireTransfer}</p><p className="text-gray-700 dark:text-gray-300 text-sm">{content.wireTransferText}</p></div></div></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h4 className="font-heading font-bold text-gray-900 dark:text-white mb-3 flex items-center gap-2">{content.smartWithdrawalStrategy}
 </h4><p className="text-gray-700 dark:text-gray-300 text-sm">{content.smartWithdrawalStrategyText}
 </p></div></div></section>{/* Real World Examples */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.realWorldExamples}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.realWorldIntro}
 </p><div className="space-y-6">{/* Example 1 */}
 <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl p-6 border-2 border-red-200 dark:border-red-800"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.example1Title}</h3><p className="text-gray-600 dark:text-gray-400 text-sm mb-4">{content.example1Subtitle}</p><div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 font-mono text-sm"><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example1Gross}</span><span className="text-gray-900 dark:text-white font-bold">$1,000</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example1ServiceFee}</span><span className="text-red-600 dark:text-red-400">-$200</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example1Connects}</span><span className="text-red-600 dark:text-red-400">-$9</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example1Withdrawal}</span><span className="text-red-600 dark:text-red-400">-$0.99</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-gray-900 dark:text-white font-bold">{content.example1Net}</span><span className="text-accent font-bold text-lg">$790.01</span></div><div className="flex justify-between text-xs text-gray-500"><span>{content.example1Effective}</span><span>21%</span></div></div></div>{/* Example 2 */}
 <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-6 border-2 border-green-200 dark:border-green-800"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.example2Title}</h3><p className="text-gray-600 dark:text-gray-400 text-sm mb-4">{content.example2Subtitle}</p><div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 font-mono text-sm"><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example2Gross}</span><span className="text-gray-900 dark:text-white font-bold">$6,000</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example2ServiceFee}</span><span className="text-red-600 dark:text-red-400">-$300</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example2Connects}</span><span className="text-gray-600 dark:text-gray-400">$0</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example2Withdrawal}</span><span className="text-red-600 dark:text-red-400">-$19.99</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example2WithdrawalFee}</span><span className="text-red-600 dark:text-red-400">-$0.99</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-gray-900 dark:text-white font-bold">{content.example2Net}</span><span className="text-accent font-bold text-lg">$5,684.02</span></div><div className="flex justify-between text-xs text-gray-500"><span>{content.example2Effective}</span><span>5.3%</span></div></div></div>{/* Example 3 */}
 <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-800"><h3 className="text-xl font-heading font-bold text-gray-900 dark:text-white mb-2">{content.example3Title}</h3><p className="text-gray-600 dark:text-gray-400 text-sm mb-4">{content.example3Subtitle}</p><div className="bg-white dark:bg-gray-900 rounded-lg p-4 space-y-2 font-mono text-sm"><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example3Gross}</span><span className="text-gray-900 dark:text-white font-bold">$25,000</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example3ServiceFee}</span><span className="text-red-600 dark:text-red-400">-$1,250</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example3Connects}</span><span className="text-gray-600 dark:text-gray-400">$0</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example3FreelancerPlus}</span><span className="text-red-600 dark:text-red-400">-$19.99</span></div><div className="flex justify-between"><span className="text-gray-600 dark:text-gray-400">{content.example3Withdrawal}</span><span className="text-red-600 dark:text-red-400">-$50</span></div><div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2"><span className="text-gray-900 dark:text-white font-bold">{content.example3Net}</span><span className="text-accent font-bold text-lg">$23,705.01</span></div><div className="flex justify-between text-xs text-gray-500"><span>{content.example3Effective}</span><span>5.2%</span></div></div></div></div></div></section>{/* Tips to Reduce Fees */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.tipsToReduceFees}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.tipsIntro}
 </p><div className="space-y-4"><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">1. {content.tip1}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip1Text}</p></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">2. {content.tip2}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip2Text}</p></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">3. {content.tip3}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip3Text}</p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">4. {content.tip4}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip4Text}</p></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-xl p-6 border-l-4 border-primary"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">5. {content.tip5}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip5Text}</p></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-xl p-6 border-l-4 border-secondary"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">6. {content.tip6}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip6Text}</p></div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-xl p-6 border-l-4 border-accent"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2">7. {content.tip7}</h3><p className="text-gray-700 dark:text-gray-300 text-sm">{content.tip7Text}</p></div></div></div></section>{/* Upwork vs Competitors */}
 <section className="mb-16"><div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8"><h2 className="text-3xl font-heading font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-3">{content.upworkVsCompetitors}
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-8">{content.upworkVsIntro}
 </p><div className="space-y-4"><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-lg p-4 border-l-4 border-primary"><div className="flex items-center justify-between"><span className="font-heading font-bold text-gray-900 dark:text-white">Upwork 2026</span><span className="text-primary font-bold">0-15% variable per contract</span></div></div><div className="text-center text-gray-400 text-sm">{content.fiverrVs}</div><div className="bg-gradient-to-r from-accent/10 to-accent/5 dark:from-accent/20 dark:to-accent/10 rounded-lg p-4 border-l-4 border-accent"><div className="flex items-center justify-between"><span className="font-heading font-bold text-gray-900 dark:text-white">{content.fiverr}</span><span className="text-accent font-bold">{content.fiverrFee}</span></div></div><div className="bg-gradient-to-r from-secondary/10 to-secondary/5 dark:from-secondary/20 dark:to-secondary/10 rounded-lg p-4 border-l-4 border-secondary"><div className="flex items-center justify-between"><span className="font-heading font-bold text-gray-900 dark:text-white">{content.freelancerCom}</span><span className="text-secondary font-bold">{content.freelancerComFee}</span></div></div><div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 rounded-lg p-4 border-l-4 border-primary"><div className="flex items-center justify-between"><span className="font-heading font-bold text-gray-900 dark:text-white">{content.toptal}</span><span className="text-primary font-bold">{content.toptalFee}</span></div></div><div className="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-4 border-l-4 border-green-500"><div className="flex items-center justify-between"><span className="font-heading font-bold text-gray-900 dark:text-white">{content.direct}</span><span className="text-green-600 font-bold">{content.directFee}</span></div></div></div><div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500"><p className="text-gray-700 dark:text-gray-300 text-sm"><strong className="text-gray-900 dark:text-white">{content.bottomLine}</strong>{content.bottomLineText}
 </p></div></div></section>{/* Final Verdict */}
 ...
 </h2><p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{content.verdictIntro}
 </p><div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed"><p><strong className="text-gray-900 dark:text-white">{content.verdictNewbies}</strong>{content.verdictNewbiesText}
 </p><p><strong className="text-gray-900 dark:text-white">{content.verdictEstablished}</strong>{content.verdictEstablishedText}
 </p><p><strong className="text-gray-900 dark:text-white">{content.verdictClients}</strong>{content.verdictClientsText}
 </p><p><strong className="text-gray-900 dark:text-white">{content.smartStrategy}</strong>{content.smartStrategyText}
 </p></div><div className="mt-6 bg-white dark:bg-gray-900 rounded-xl p-6 text-center"><div className="text-4xl font-heading font-bold text-secondary dark:text-accent mb-2">8.5/10</div><p className="text-gray-600 dark:text-gray-400">{content.worthThePrice}</p></div></div></section>{/* Internal Links */}
 ...
 </p></Link><Link href={`/${locale}/resources/upwork-complete-guide`} className="group bg-gradient-to-br from-secondary/10 to-primary/10 dark:from-secondary/20 dark:to-primary/20 rounded-xl p-6 hover:shadow-lg transition-all border border-secondary/20"><h3 className="font-heading font-bold text-gray-900 dark:text-white mb-2 group-hover:text-secondary transition-colors">{content.upworkGuide}
 </h3><p className="text-gray-600 dark:text-gray-400 text-sm">{content.upworkGuideText}
 </p></Link></div></section></div></div></article>{/* Final CTA */}
 <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"><div className="container mx-auto px-4 sm:px-6 lg:px-8"><div className="max-w-4xl mx-auto text-center"><h2 className="text-3xl sm:text-4xl font-heading font-bold text-gray-900 dark:text-white mb-6">{content.maximizeEarnings}
 </h2><p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">{content.maximizeEarningsText}
 </p><div className="flex flex-wrap justify-center gap-4"><Link
 href={`/${locale}/platforms`}
