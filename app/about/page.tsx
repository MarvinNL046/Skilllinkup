...
import BreadcrumbTwo from "../../src/common/elements/breadcrumb/breadcrumbTwo";
...
import WidgetCategory from "../../src/common/components/sidebar/WidgetCategory";
import WidgetSearch from "../../src/common/components/sidebar/WidgetSearch";
import WidgetPostList from "../../src/common/components/sidebar/WidgetPostList";
import WidgetSocialShare from "../../src/common/components/sidebar/WidgetSocialShare";

export const metadata = {
  title: 'About Us - SkillLinkup',
  description: 'Learn more about SkillLinkup',
}
...
export default function AboutPage() {
    ...
    return (
        <>
            <HeaderOne pClass="" darkLogo="/images/logo/logo-black.png" lightLogo="/images/logo/logo-white.png" postData={allPosts} />
            <BreadcrumbTwo
                title="About Us"
            ...
            <FooterThree bgColor="" darkLogo="/images/logo/logo-black.png" lightLogo="/images/logo/logo-white.png" />
        </>
    );
}
