...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.skilllinkup.com https://*.posthog.com",
      ...
      "frame-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.skilllinkup.com",
