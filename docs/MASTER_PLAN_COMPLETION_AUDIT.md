...
| Responsive/UI quality       | Proven on core public and deep workspace scope      | Chromium matrices at 375, 768, 1280 and 1440; accessibility suite; sidebar plus Online/Local keyboard-focus smoke checks      | complete keyboard-only audit of remaining tables, modals and filters                   |
