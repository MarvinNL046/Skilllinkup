...
const config = {
  ...
  trust: ["Visible identity checks", "Local service radius", "Clear quotes"],
  proof: { label: "Launch hypothesis", value: "Rotterdam–The Hague" },
  rating: { value: "Five trades", label: "Focused private beta" },
  stats: [
    { icon: "local", value: "Nearby", label: "Distance-based matching" },
    { icon: "verified", value: "Visible", label: "Identity and credentials" },
