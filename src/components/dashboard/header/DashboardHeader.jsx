...
export default function DashboardHeader() {
  ...
  return (
    <header className={styles.header}>
      <div className={styles.mobileBrand}><button type="button" onClick={toggleMobile} aria-label="Open dashboard navigation"><Menu size={21} /></button><Link href="/"><Image src="/images/logo/skilllinkup-logo.png" alt="Skilllinkup" width={736} height={168} priority /></Link></div>
