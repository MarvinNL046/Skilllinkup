...
export default function DashboardHeader() {
  ...
  const mobileOpen = dashboardSidebarStore((state) => state.mobileOpen);
  ...
  return (
    <header className={styles.header}>
      <div className={styles.mobileBrand}>
        <button
          id="dashboard-navigation-trigger"
          type="button"
      ...
      <form className={styles.search} action="/online/services">
        <Search size={18} />
        <input
          name="q"
          aria-label="Search Skilllinkup"
          placeholder="Search services, professionals or skills…"
        />
      </form>
      <div className={styles.actions}>
        <NotificationBell />
        <Link href="/help" className={styles.iconButton} aria-label="Help">
          <CircleHelp size={20} />
        </Link>
