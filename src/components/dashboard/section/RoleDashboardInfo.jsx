...
const configurations = {
  "client:local": {
    ...
    description: "Compare quotes, check appointments and keep track of work at your location.",
    ...
    emptyText: "Describe the work and your location so local professionals can decide whether to quote.",
  },
  "local_professional:local": {
    eyebrow: "Local professional",
    title: "Your local requests and appointments",
    ...
    emptyText: "Browse requests in your service area and choose one that fits your skills and availability.",
  },
  "candidate:jobs": {
    eyebrow: "Job seeker",
    ...
    action: { href: "/jobs/browse", label: "Browse jobs", Icon: Search },
    sectionTitle: "Recent applications",
    viewAllHref: "/dashboard/applications",
    emptyTitle: "No applications yet",
    emptyText: "Browse jobs, check the requirements and apply when a role fits your experience.",
  },
  "company:jobs": {
    ...
    emptyText: "Describe the role, requirements and working arrangements, then review your listing before publishing.",
  },
};
