...
export default function CreateQuoteRequestInfo() {
  ...
  return <div className={styles.page}>
    ...
    <div className={styles.layout}><form onSubmit={submit}>
      ...
      <footer><button type="button" className="skl-action-secondary" onClick={() => router.push("/local")}>Cancel</button><button type="submit" className="skl-action-primary" disabled={busy}>{busy ? "Publishing…" : "Request quotes"}<ArrowRight /></button></footer>
