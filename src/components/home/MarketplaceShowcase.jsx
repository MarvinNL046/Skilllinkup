...
const products = [
  { label: "Online services", eyebrow: "Work worldwide", description: "Find freelancers for websites, design, marketing and other work you can do remotely.", examples: ["Development", "Design", "Marketing"], cta: "Explore Online", href: "/online", image: "/images/skilllinkup-products/online-services-v1.png", Icon: Globe2, tone: "coral" },
  { label: "Local services", eyebrow: "Help near you", description: "Explore professionals for repairs, maintenance and other work at your location.", examples: ["Plumbing", "Carpentry", "HVAC"], cta: "Explore Local", href: "/local", image: "/images/skilllinkup-products/local-services-v1.png", Icon: Wrench, tone: "mint" },
  { label: "Jobs", eyebrow: "Build your career", description: "Explore company roles and check the location, requirements and working arrangements.", examples: ["Remote", "Local", "Full-time"], cta: "Explore Jobs", href: "/jobs", image: "/images/skilllinkup-products/jobs-v1.png", Icon: BriefcaseBusiness, tone: "navy" },
];
  ...
  return (
    <>
      <section className={`${styles.section} ${styles.productSection}`}>
        <header className={styles.centerHeading}><span className={styles.eyebrow}>One account, three worlds</span><h2>What are you looking for?</h2><p>Explore Online, Local or Jobs, then choose how you want to take part.</p></header>
