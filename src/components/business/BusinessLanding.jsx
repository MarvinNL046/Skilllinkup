...
import { ArrowRight, BadgeCheck, BriefcaseBusiness, Check, Clock3, FileCheck2, FileText, Gauge, Languages, LayoutDashboard, LockKeyhole, Megaphone, MessageSquareMore, ShieldCheck, Target, UsersRound } from "lucide-react";
import WaitlistButton from "@/components/ui/WaitlistButton";
import styles from "./BusinessLanding.module.css";

const features = [
  { title: "One place to search", text: "Find the right specialist across local and online work.", Icon: UsersRound },
  { title: "Compare professional profiles", text: "Profiles, skills, experience and trust signals in one view.", Icon: BadgeCheck },
  { title: "Written scope and approvals", text: "Clear agreements and auditable project records.", Icon: FileCheck2 },
  ...
  { title: "Contact support", text: "Ask a question or report a problem from your account.", Icon: MessageSquareMore },
];
...
const faqs = [
  ["How quickly can you provide a professional?", "Availability and responses depend on the skill, location and scope. Browse published profiles or post a clear project brief to start comparing options."],
  ["Are professionals screened?", "Profiles show published experience, work samples and any verification badge. Assess the skills and qualifications needed for your specific work before hiring."],
  ...
  ["Can Skilllinkup integrate with our systems?", "The beta provides its own dashboard and workspace. Contact us to discuss an integration requirement before planning around it."],
...
export default function BusinessLanding() {
  return <main className={styles.page}>
    ...
    <section className={`${styles.container} ${styles.stats}`}><article><UsersRound /><span><strong>One account</strong><small>Multiple professional roles</small></span></article><article><BriefcaseBusiness /><span><strong>3 worlds</strong><small>Online, Local and Jobs</small></span></article><article><Clock3 /><span><strong>Free beta</strong><small>No platform payments</small></span></article><article><Languages /><span><strong>English-first</strong><small>Worldwide Online launch</small></span></article></section>
    ...
    <section id="demo" className={`${styles.container} ${styles.demoCta}`}><div><span className={styles.eyebrow}>Let’s talk</span><h2>Discover what Skilllinkup can do for your organisation</h2><p>Tell us about your team and the workflow you want to try. Use the contact form to request a demo.</p></div><div><Button asChild className={styles.demoLink}><Link href="/contact">Request a demo<ArrowRight /></Link></Button></div><footer><span><MessageSquareMore />Tell us your use case</span><span><ShieldCheck />No obligation</span><span><Check />Tailored advice</span></footer></section>
  </main>;
}
