...
export default function BusinessLanding() {
  return <main className={styles.page}>
    ...
    <section id="demo" className={`${styles.container} ${styles.demoCta}`}><div><span className={styles.eyebrow}>Let’s talk</span><h2>Discover what Skilllinkup can do for your organisation</h2><p>Tell us about your team and the workflow you want to try. Use the contact form to request a demo.</p></div><div><Link className={styles.demoLink} href="/contact">Request a demo<ArrowRight /></Link></div><footer><span><MessageSquareMore />Tell us your use case</span><span><ShieldCheck />No obligation</span><span><Check />Tailored advice</span></footer></section>
  </main>;
}
