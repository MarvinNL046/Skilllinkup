...
const _message      = { id: 6,  name: "Messages",          icon: "flaticon-chat",         path: "/message" };
const _reviews      = { id: 7,  name: "Reviews",          icon: "flaticon-review-1",     path: "/reviews" };
const _payouts      = { id: 8,  name: "Payment policy",   icon: "flaticon-dollar",       path: "/payouts" };
const _statements   = { id: 9,  name: "Scope records",    icon: "flaticon-web",          path: "/statements" };
const _invoice      = { id: 10, name: "Invoice policy",   icon: "flaticon-receipt",      path: "/invoice" };
...
const _credits      = { id: 13, name: "Beta lead access", icon: "flaticon-dollar",       path: "/dashboard/credits" };
